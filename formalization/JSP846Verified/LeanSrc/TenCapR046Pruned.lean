...
namespace JSP846TenCap.R046
open JSP846Standard
def chords : Finset (Sym2 (Fin 10)) := {s(0,1),s(2,9),s(3,6),s(4,7),s(5,8)}
...
theorem z8_not_cycle : ¬ IsSymbolicCycle (by decide : 0 < 10)
  ...
  all_goals decide +kernel
def z9 : Fin 2 × Finset (Sym2 (Fin 10)) := ((1:Fin 2), {s(0,1),s(3,6),s(4,7)})
...
theorem z9_not_cycle : ¬ IsSymbolicCycle (by decide : 0 < 10)
  ...
  all_goals decide +kernel
def z10 : Fin 2 × Finset (Sym2 (Fin 10)) := ((1:Fin 2), {s(2,9),s(3,6),s(4,7)})
...
theorem z10_not_cycle : ¬ IsSymbolicCycle (by decide : 0 < 10)
  ...
  all_goals decide +kernel
def z11 : Fin 2 × Finset (Sym2 (Fin 10)) := ((0:Fin 2), {s(0,1),s(2,9),s(3,6),s(4,7)})
...
theorem z11_not_cycle : ¬ IsSymbolicCycle (by decide : 0 < 10)
  ...
  all_goals decide +kernel
def z12 : Fin 2 × Finset (Sym2 (Fin 10)) := ((1:Fin 2), {s(0,1),s(2,9),s(3,6),s(4,7)})
...
theorem z12_not_cycle : ¬ IsSymbolicCycle (by decide : 0 < 10)
  ...
  all_goals decide +kernel
def z13 : Fin 2 × Finset (Sym2 (Fin 10)) := ((1:Fin 2), {s(0,1),s(5,8)})
...
theorem z13_not_cycle : ¬ IsSymbolicCycle (by decide : 0 < 10)
  ...
  all_goals decide +kernel
def z14 : Fin 2 × Finset (Sym2 (Fin 10)) := ((1:Fin 2), {s(2,9),s(5,8)})
...
theorem z14_not_cycle : ¬ IsSymbolicCycle (by decide : 0 < 10)
  ...
  all_goals decide +kernel
def z15 : Fin 2 × Finset (Sym2 (Fin 10)) := ((0:Fin 2), {s(0,1),s(2,9),s(5,8)})
...
theorem z15_not_cycle : ¬ IsSymbolicCycle (by decide : 0 < 10)
  ...
  all_goals decide +kernel
def z16 : Fin 2 × Finset (Sym2 (Fin 10)) := ((1:Fin 2), {s(0,1),s(2,9),s(5,8)})
...
theorem z16_not_cycle : ¬ IsSymbolicCycle (by decide : 0 < 10)
  ...
  all_goals decide +kernel
def z17 : Fin 2 × Finset (Sym2 (Fin 10)) := ((1:Fin 2), {s(0,1),s(3,6),s(5,8)})
...
theorem z17_not_cycle : ¬ IsSymbolicCycle (by decide : 0 < 10)
  ...
  all_goals decide +kernel
def z18 : Fin 2 × Finset (Sym2 (Fin 10)) := ((1:Fin 2), {s(2,9),s(3,6),s(5,8)})
...
theorem z18_not_cycle : ¬ IsSymbolicCycle (by decide : 0 < 10)
  ...
  all_goals decide +kernel
def z19 : Fin 2 × Finset (Sym2 (Fin 10)) := ((0:Fin 2), {s(0,1),s(2,9),s(3,6),s(5,8)})
...
theorem z19_not_cycle : ¬ IsSymbolicCycle (by decide : 0 < 10)
  ...
  all_goals decide +kernel
def z20 : Fin 2 × Finset (Sym2 (Fin 10)) := ((1:Fin 2), {s(0,1),s(2,9),s(3,6),s(5,8)})
...
theorem z20_not_cycle : ¬ IsSymbolicCycle (by decide : 0 < 10)
  ...
  all_goals decide +kernel
def z21 : Fin 2 × Finset (Sym2 (Fin 10)) := ((1:Fin 2), {s(0,1),s(4,7),s(5,8)})
...
theorem z21_not_cycle : ¬ IsSymbolicCycle (by decide : 0 < 10)
  ...
  all_goals decide +kernel
def z22 : Fin 2 × Finset (Sym2 (Fin 10)) := ((1:Fin 2), {s(2,9),s(4,7),s(5,8)})
def C22 : Finset (Fin 10) := {0,1,2,9}
theorem z22_not_cycle : ¬ IsSymbolicCycle (by decide : 0 < 10)
  ...
  all_goals decide +kernel
def z23 : Fin 2 × Finset (Sym2 (Fin 10)) := ((0:Fin 2), {s(0,1),s(2,9),s(4,7),s(5,8)})
...
theorem z23_not_cycle : ¬ IsSymbolicCycle (by decide : 0 < 10)
  ...
  all_goals decide +kernel
def z24 : Fin 2 × Finset (Sym2 (Fin 10)) := ((1:Fin 2), {s(0,1),s(2,9),s(4,7),s(5,8)})
...
theorem z24_not_cycle : ¬ IsSymbolicCycle (by decide : 0 < 10)
  ...
  all_goals decide +kernel
def z25 : Fin 2 × Finset (Sym2 (Fin 10)) := ((1:Fin 2), {s(0,1),s(3,6),s(4,7),s(5,8)})
...
theorem z25_not_cycle : ¬ IsSymbolicCycle (by decide : 0 < 10)
  ...
  all_goals decide +kernel
def z26 : Fin 2 × Finset (Sym2 (Fin 10)) := ((1:Fin 2), {s(2,9),s(3,6),s(4,7),s(5,8)})
...
theorem z26_not_cycle : ¬ IsSymbolicCycle (by decide : 0 < 10)
  ...
  all_goals decide +kernel
def z27 : Fin 2 × Finset (Sym2 (Fin 10)) := ((0:Fin 2), {s(0,1),s(2,9),s(3,6),s(4,7),s(5,8)})
...
theorem z27_not_cycle : ¬ IsSymbolicCycle (by decide : 0 < 10)
  ...
  all_goals decide +kernel
def z28 : Fin 2 × Finset (Sym2 (Fin 10)) := ((1:Fin 2), {s(0,1),s(2,9),s(3,6),s(4,7),s(5,8)})
def C28 : Finset (Fin 10) := {0,1}
theorem z28_not_cycle : ¬ IsSymbolicCycle (by decide : 0 < 10)
    (reconstructArcs z28.2 z28.1.val) z28.2 := by
  apply symbolic_cut_contradiction (by decide : 0 < 10)
    (reconstructArcs z28.2 z28.1.val) z28.2 C28 (0:Fin 10) (2:Fin 10)
  all_goals decide +kernel
def bad : Finset (Fin 2 × Finset (Sym2 (Fin 10))) := {z0,z1,z2,z3,z4,z5,z6,z7,z8,z9,z10,z11,z12,z13,z14,z15,z16,z17,z18,z19,z20,z21,z22,z23,z24,z25,z26,z27,z28}
theorem bad_not_cycle : ∀ z ∈ bad,
  ...
  rcases hz with h0 | h1 | h2 | h3 | h4 | h5 | h6 | h7 | h8 | h9 | h10 | h11 | h12 | h13 | h14 | h15 | h16 | h17 | h18 | h19 | h20 | h21 | h22 | h23 | h24 | h25 | h26 | h27 | h28
...
theorem rep_eq : tenRepAt (46:Fin 79) = chords := by decide +kernel
theorem rep_excluded : ¬ ModelFeasible (by decide : 0 < 10) (tenRepAt (46:Fin 79)) := by
  rw [rep_eq]
  exact excluded
end JSP846TenCap.R046
#print axioms JSP846TenCap.R046.small
#print axioms JSP846TenCap.R046.rep_excluded
