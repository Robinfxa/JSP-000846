...
theorem excluded : ¬ ModelFeasible (by decide : 0 < 9) chords := by
  ...
  have hb : JSP846Residual.Bounds JSP846Residual.HintCases.C272.lower xs := by
    simp [JSP846Residual.HintCases.C272.lower, xs, JSP846HintBridge.finList9,
  ...
  have hc' : JSP846Replay.Covers
      (JSP846Replay.values (JSP846HintBridge.listWeight xs)
        (JSP846Residual.HintCases.C272.forms.map JSP846HintBridge.exprToForm)) := by
    have hwEq := JSP846HintBridge.listWeight_finList9 w
    rw [hwEq]
    simpa [replayForms] using hc
  have ho : JSP846Residual.OriginalFeasible
      JSP846Residual.HintCases.C272.lower
      JSP846Residual.HintCases.C272.forms :=
    JSP846HintBridge.originalFeasible_of_replay
      JSP846Residual.HintCases.C272.lower
      JSP846Residual.HintCases.C272.forms xs hb hs hc'
  exact JSP846Residual.HintCases.C272.infeasible ho
end JSP846NineLarge.C272P
#print axioms JSP846NineLarge.C272P.excluded
