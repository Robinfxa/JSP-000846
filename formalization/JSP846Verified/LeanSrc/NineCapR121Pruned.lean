...
namespace JSP846Nine.R121P
open JSP846Standard
def chords : Finset (Sym2 (Fin 9)) := {s(0,1),s(2,4),s(3,6),s(3,8),s(5,7)}
...
theorem z16_not_cycle : ¬ IsSymbolicCycle (by decide : 0 < 9) (reconstructArcs z16.2 z16.1.val) z16.2 := by
  ...
  all_goals decide +kernel
def z17 : Fin 2 × Finset (Sym2 (Fin 9)) := ((1:Fin 2), {s(0,1),s(3,6),s(3,8),s(5,7)})
...
end JSP846Nine.R121P
#print axioms JSP846Nine.R121P.infeasible
