import MicroC253_094
set_option autoImplicit false
set_option maxRecDepth 100000
set_option maxHeartbeats 8000000
namespace JSP846DAG.C253
open JSP846Replay
def fs_290271086510145 : List Form := [(3,[]),(6,[2,3]),(5,[2,3]),(6,[2,5]),(5,[2,5]),(4,[3,5]),(5,[2,6]),(6,[2,6]),(7,[3,6]),(8,[3,6]),(5,[5,6]),(6,[5,6]),(7,[2,3,5,6]),(8,[2,3,5,6]),(7,[2,3]),(8,[2,3]),(7,[]),(8,[]),(9,[3,5]),(10,[3,5]),(9,[2,5]),(10,[2,5]),(6,[3,6]),(10,[2,6]),(9,[2,6]),(10,[2,3,5,6]),(9,[2,3,5,6]),(6,[5,6]),(5,[2,3]),(6,[2,3]),(5,[]),(6,[]),(7,[3,5]),(8,[3,5]),(7,[2,5]),(8,[2,5]),(6,[3,6]),(9,[2,6]),(9,[2,3,5,6]),(6,[5,6]),(4,[]),(7,[2,6]),(8,[2,6]),(9,[3,6]),(10,[3,6]),(7,[5,6]),(8,[5,6]),(9,[2,3,5,6]),(10,[2,3,5,6])]
...
theorem node_290271086510145 (x : Nat → Nat) (hs : x 2 + (x 3 + (x 5 + (x 6 + (0)))) = 31)
  ...
  · have hchoices : (x 2 = 0 ∧ x 5 = 4) ∨ (x 2 = 1 ∧ x 5 = 3) ∨ (x 2 = 2 ∧ x 5 = 2) ∨ (x 2 = 3 ∧ x 5 = 1) ∨ (x 2 = 4 ∧ x 5 = 0) := by
    ...
    · have hchild := hc
      ...
      change Covers (values x fs_290276455223361) at hchild

      exact node_290276455223361 x (by omega) hchild
    ...
    · have hchild := hc
      ...
      change Covers (values x fs_290275381485633) at hchild

      exact node_290275381485633 x (by omega) hchild
    ...
    · have hchild := hc
      ...
      change Covers (values x fs_290274307747905) at hchild

      exact node_290274307747905 x (by omega) hchild
    ...
    · have hchild := hc
      ...
      change Covers (values x fs_290272160272449) at hchild

      exact node_290272160272449 x (by omega) hchild
  ...
  · have hchoices : (x 3 = 0 ∧ x 6 = 4) ∨ (x 3 = 1 ∧ x 6 = 3) ∨ (x 3 = 2 ∧ x 6 = 2) ∨ (x 3 = 3 ∧ x 6 = 1) ∨ (x 3 = 4 ∧ x 6 = 0) := by
    ...
    · have hchild := hc
      ...
      change Covers (values x fs_290614684155969) at hchild

      exact node_290614684155969 x (by omega) hchild
    ...
    · have hchild := hc
      ...
      change Covers (values x fs_290545964941377) at hchild

      exact node_290545964941377 x (by omega) hchild
    ...
    · have hchild := hc
      ...
      change Covers (values x fs_290477245726785) at hchild

      exact node_290477245726785 x (by omega) hchild
    ...
    · have hchild := hc
      ...
      change Covers (values x fs_290408526512193) at hchild

      exact node_290408526512193 x (by omega) hchild
    ...
    · have hchild := hc
      ...
      change Covers (values x fs_290339807297601) at hchild

      exact node_290339807297601 x (by omega) hchild
