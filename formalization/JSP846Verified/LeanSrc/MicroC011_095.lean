import MicroC011_094
set_option autoImplicit false
set_option maxRecDepth 100000
set_option maxHeartbeats 8000000
namespace JSP846DAG.C011
open JSP846Replay
def fs_16777347 : List Form := [(4,[]),(3,[]),(5,[2,3]),(7,[2,3]),(6,[2,3]),(8,[2,3]),(5,[]),(7,[]),(6,[]),(8,[]),(4,[2,3]),(4,[2,5]),(7,[3,5]),(9,[3,5]),(8,[3,5]),(10,[3,5]),(7,[2,5]),(9,[2,5]),(8,[2,5]),(10,[2,5]),(4,[3,5]),(5,[2,6]),(7,[2,6]),(6,[2,6]),(8,[2,6]),(4,[3,6]),(6,[2,6]),(7,[3,6]),(9,[3,6]),(8,[3,6]),(10,[3,6]),(5,[5,6]),(7,[5,6]),(6,[5,6]),(8,[5,6]),(6,[2,3,5,6]),(4,[5,6]),(7,[2,3,5,6]),(9,[2,3,5,6]),(8,[2,3,5,6]),(10,[2,3,5,6])]
...
theorem node_16777347 (x : Nat → Nat) (hs : x 2 + (x 3 + (x 5 + (x 6 + (0)))) = 31)
  ...
  have hopts : (x 2 + (x 3 + (0)) = 0) ∨ (x 2 + (x 3 + (0)) = 1) ∨ (x 2 + (x 3 + (0)) = 2) ∨ (x 2 + (x 3 + (0)) = 3) ∨ (x 2 + (x 5 + (0)) = 2) ∨ (x 2 + (x 5 + (0)) = 3) ∨ (x 2 + (x 5 + (0)) = 4) ∨ (x 2 + (x 5 + (0)) = 5) ∨ (x 2 + (x 6 + (0)) = 2) ∨ (x 2 + (x 6 + (0)) = 3) ∨ (x 2 + (x 6 + (0)) = 4) ∨ (x 2 + (x 6 + (0)) = 5) ∨ (x 3 + (x 5 + (0)) = 0) ∨ (x 3 + (x 5 + (0)) = 1) ∨ (x 3 + (x 5 + (0)) = 2) ∨ (x 3 + (x 5 + (0)) = 3) ∨ (x 3 + (x 6 + (0)) = 2) ∨ (x 3 + (x 6 + (0)) = 3) ∨ (x 3 + (x 6 + (0)) = 4) ∨ (x 3 + (x 6 + (0)) = 5) ∨ (x 5 + (x 6 + (0)) = 0) ∨ (x 5 + (x 6 + (0)) = 1) ∨ (x 5 + (x 6 + (0)) = 2) ∨ (x 5 + (x 6 + (0)) = 3) := by
  ...
  rcases hopts with ho | ho | ho | ho | ho | ho | ho | ho | ho | ho | ho | ho | ho | ho | ho | ho | ho | ho | ho | ho | ho | ho | ho | ho
  ...
  · have hchoices : (x 2 = 0 ∧ x 5 = 4) ∨ (x 2 = 1 ∧ x 5 = 3) ∨ (x 2 = 2 ∧ x 5 = 2) ∨ (x 2 = 3 ∧ x 5 = 1) ∨ (x 2 = 4 ∧ x 5 = 0) := by

      have hm := JSP846Compositions.mem_compositions [x 2,x 5] 4 ho

      change [x 2,x 5] ∈ [[0,4],[1,3],[2,2],[3,1],[4,0]] at hm
    ...
    · have hchild := hc
      ...
      change Covers (values x fs_5385490563) at hchild

      exact node_5385490563 x (by omega) hchild
    ...
    · have hchild := hc
      ...
      change Covers (values x fs_4311752835) at hchild

      exact node_4311752835 x (by omega) hchild
    ...
    · have hchild := hc
      ...
      change Covers (values x fs_3238015107) at hchild

      exact node_3238015107 x (by omega) hchild
    ...
    · have hchild := hc
      ...
      change Covers (values x fs_2164277379) at hchild

      exact node_2164277379 x (by omega) hchild
    ...
    · have hchild := hc
      ...
      change Covers (values x fs_1090539651) at hchild

      exact node_1090539651 x (by omega) hchild

  · have hchoices : (x 2 = 0 ∧ x 5 = 5) ∨ (x 2 = 1 ∧ x 5 = 4) ∨ (x 2 = 2 ∧ x 5 = 3) ∨ (x 2 = 3 ∧ x 5 = 2) ∨ (x 2 = 4 ∧ x 5 = 1) ∨ (x 2 = 5 ∧ x 5 = 0) := by

      have hm := JSP846Compositions.mem_compositions [x 2,x 5] 5 ho

      change [x 2,x 5] ∈ [[0,5],[1,4],[2,3],[3,2],[4,1],[5,0]] at hm
    ...
    · have hchild := hc
      ...
      change Covers (values x fs_6459232387) at hchild

      exact node_6459232387 x (by omega) hchild
    ...
    · have hchild := hc
      ...
      change Covers (values x fs_5385494659) at hchild

      exact node_5385494659 x (by omega) hchild
    ...
    · have hchild := hc
      ...
      change Covers (values x fs_4311756931) at hchild

      exact node_4311756931 x (by omega) hchild
    ...
    · have hchild := hc
      ...
      change Covers (values x fs_3238019203) at hchild

      exact node_3238019203 x (by omega) hchild
    ...
    · have hchild := hc
      ...
      change Covers (values x fs_2164281475) at hchild

      exact node_2164281475 x (by omega) hchild
    ...
    · have hchild := hc
      ...
      change Covers (values x fs_1090543747) at hchild

      exact node_1090543747 x (by omega) hchild
  ...
  · have hchoices : (x 2 = 0 ∧ x 6 = 5) ∨ (x 2 = 1 ∧ x 6 = 4) ∨ (x 2 = 2 ∧ x 6 = 3) ∨ (x 2 = 3 ∧ x 6 = 2) ∨ (x 2 = 4 ∧ x 6 = 1) ∨ (x 2 = 5 ∧ x 6 = 0) := by

      have hm := JSP846Compositions.mem_compositions [x 2,x 6] 5 ho

      change [x 2,x 6] ∈ [[0,5],[1,4],[2,3],[3,2],[4,1],[5,0]] at hm
    ...
    · have hchild := hc
      ...
      change Covers (values x fs_412333641859) at hchild

      exact node_412333641859 x (by omega) hchild
    ...
    · have hchild := hc
      ...
      change Covers (values x fs_343614169219) at hchild

      exact node_343614169219 x (by omega) hchild
    ...
    · have hchild := hc
      ...
      change Covers (values x fs_274894696579) at hchild

      exact node_274894696579 x (by omega) hchild
    ...
    · have hchild := hc
      ...
      change Covers (values x fs_206175223939) at hchild

      exact node_206175223939 x (by omega) hchild
    ...
    · have hchild := hc
      ...
      change Covers (values x fs_137455751299) at hchild

      exact node_137455751299 x (by omega) hchild
    ...
    · have hchild := hc
      ...
      change Covers (values x fs_68736278659) at hchild

      exact node_68736278659 x (by omega) hchild
  ...
  · have hchoices : (x 3 = 0 ∧ x 5 = 3) ∨ (x 3 = 1 ∧ x 5 = 2) ∨ (x 3 = 2 ∧ x 5 = 1) ∨ (x 3 = 3 ∧ x 5 = 0) := by
    ...
    · have hchild := hc
      ...
      change Covers (values x fs_4312006787) at hchild

      exact node_4312006787 x (by omega) hchild
    ...
    · have hchild := hc
      ...
      change Covers (values x fs_3238527107) at hchild

      exact node_3238527107 x (by omega) hchild
    ...
    · have hchild := hc
      ...
      change Covers (values x fs_2165047427) at hchild

      exact node_2165047427 x (by omega) hchild
    ...
    · have hchild := hc
      ...
      change Covers (values x fs_1091567747) at hchild

      exact node_1091567747 x (by omega) hchild
  ...
  · have hchoices : (x 3 = 0 ∧ x 6 = 4) ∨ (x 3 = 1 ∧ x 6 = 3) ∨ (x 3 = 2 ∧ x 6 = 2) ∨ (x 3 = 3 ∧ x 6 = 1) ∨ (x 3 = 4 ∧ x 6 = 0) := by
    ...
    · have hchild := hc
      ...
      change Covers (values x fs_343614423171) at hchild

      exact node_343614423171 x (by omega) hchild
    ...
    · have hchild := hc
      ...
      change Covers (values x fs_274895208579) at hchild

      exact node_274895208579 x (by omega) hchild
    ...
    · have hchild := hc
      ...
      change Covers (values x fs_206175993987) at hchild

      exact node_206175993987 x (by omega) hchild
    ...
    · have hchild := hc
      ...
      change Covers (values x fs_137456779395) at hchild

      exact node_137456779395 x (by omega) hchild
    ...
    · have hchild := hc
      ...
      change Covers (values x fs_68737564803) at hchild

      exact node_68737564803 x (by omega) hchild

  · have hchoices : (x 3 = 0 ∧ x 6 = 5) ∨ (x 3 = 1 ∧ x 6 = 4) ∨ (x 3 = 2 ∧ x 6 = 3) ∨ (x 3 = 3 ∧ x 6 = 2) ∨ (x 3 = 4 ∧ x 6 = 1) ∨ (x 3 = 5 ∧ x 6 = 0) := by

      have hm := JSP846Compositions.mem_compositions [x 3,x 6] 5 ho

      change [x 3,x 6] ∈ [[0,5],[1,4],[2,3],[3,2],[4,1],[5,0]] at hm
    ...
    · have hchild := hc
      ...
      change Covers (values x fs_412333899907) at hchild

      exact node_412333899907 x (by omega) hchild
    ...
    · have hchild := hc
      ...
      change Covers (values x fs_343614685315) at hchild

      exact node_343614685315 x (by omega) hchild
    ...
    · have hchild := hc
      ...
      change Covers (values x fs_274895470723) at hchild

      exact node_274895470723 x (by omega) hchild
    ...
    · have hchild := hc
      ...
      change Covers (values x fs_206176256131) at hchild

      exact node_206176256131 x (by omega) hchild
    ...
    · have hchild := hc
      ...
      change Covers (values x fs_137457041539) at hchild

      exact node_137457041539 x (by omega) hchild
    ...
    · have hchild := hc
      ...
      change Covers (values x fs_68737826947) at hchild

      exact node_68737826947 x (by omega) hchild
