...
namespace JSP846Seven.R076
open JSP846Standard
def chords : Finset (Sym2 (Fin 7)) := {s(0,1),s(0,2),s(1,4),s(3,6),s(4,5)}
...
end JSP846Seven.R076
#print axioms JSP846Seven.R076.infeasible
namespace JSP846Seven.R077
open JSP846Standard
def chords : Finset (Sym2 (Fin 7)) := {s(0,1),s(0,2),s(1,4),s(3,6),s(5,6)}
def z0 : Fin 2 × Finset (Sym2 (Fin 7)) := ((1:Fin 2), {s(0,1),s(3,6)})
def C0 : Finset (Fin 7) := {0,1}
theorem z0_not_cycle : ¬ IsSymbolicCycle (by decide : 0 < 7) (reconstructArcs z0.2 z0.1.val) z0.2 := by
  apply symbolic_cut_contradiction (by decide : 0 < 7)
...
theorem z8_not_cycle : ¬ IsSymbolicCycle (by decide : 0 < 7) (reconstructArcs z8.2 z8.1.val) z8.2 := by
  ...
  all_goals decide +kernel
def z9 : Fin 2 × Finset (Sym2 (Fin 7)) := ((1:Fin 2), {s(0,1),s(3,6),s(5,6)})
def C9 : Finset (Fin 7) := {0,1}
theorem z9_not_cycle : ¬ IsSymbolicCycle (by decide : 0 < 7) (reconstructArcs z9.2 z9.1.val) z9.2 := by
  apply symbolic_cut_contradiction (by decide : 0 < 7)
    (reconstructArcs z9.2 z9.1.val) z9.2 C9 (0:Fin 7) (3:Fin 7)
  all_goals decide +kernel
def z10 : Fin 2 × Finset (Sym2 (Fin 7)) := ((1:Fin 2), {s(0,2),s(3,6),s(5,6)})
def C10 : Finset (Fin 7) := {0,1,2}
theorem z10_not_cycle : ¬ IsSymbolicCycle (by decide : 0 < 7) (reconstructArcs z10.2 z10.1.val) z10.2 := by
  apply symbolic_cut_contradiction (by decide : 0 < 7)
    (reconstructArcs z10.2 z10.1.val) z10.2 C10 (0:Fin 7) (3:Fin 7)
  all_goals decide +kernel
def z11 : Fin 2 × Finset (Sym2 (Fin 7)) := ((0:Fin 2), {s(0,1),s(0,2),s(3,6),s(5,6)})
def C11 : Finset (Fin 7) := {0,1,2}
theorem z11_not_cycle : ¬ IsSymbolicCycle (by decide : 0 < 7) (reconstructArcs z11.2 z11.1.val) z11.2 := by
  apply symbolic_cut_contradiction (by decide : 0 < 7)
    (reconstructArcs z11.2 z11.1.val) z11.2 C11 (0:Fin 7) (3:Fin 7)
...
theorem infeasible : ¬ ModelFeasible (by decide : 0 < 7) chords :=
  no_model_of_pruned_forms_card (by decide) (by decide) chords bad bad_not_cycle small
end JSP846Seven.R077
#print axioms JSP846Seven.R077.infeasible
namespace JSP846Seven.R078
open JSP846Standard
def chords : Finset (Sym2 (Fin 7)) := {s(0,1),s(0,2),s(1,5),s(2,3),s(4,6)}
...
theorem z0_not_cycle : ¬ IsSymbolicCycle (by decide : 0 < 7) (reconstructArcs z0.2 z0.1.val) z0.2 := by
  ...
  all_goals decide +kernel
def z1 : Fin 2 × Finset (Sym2 (Fin 7)) := ((1:Fin 2), {s(1,5),s(2,3)})
def C1 : Finset (Fin 7) := {0,1,5,6}
theorem z1_not_cycle : ¬ IsSymbolicCycle (by decide : 0 < 7) (reconstructArcs z1.2 z1.1.val) z1.2 := by
  apply symbolic_cut_contradiction (by decide : 0 < 7)
    (reconstructArcs z1.2 z1.1.val) z1.2 C1 (0:Fin 7) (2:Fin 7)
  all_goals decide +kernel
def z2 : Fin 2 × Finset (Sym2 (Fin 7)) := ((0:Fin 2), {s(0,1),s(1,5),s(2,3)})
...
theorem z5_not_cycle : ¬ IsSymbolicCycle (by decide : 0 < 7) (reconstructArcs z5.2 z5.1.val) z5.2 := by
  apply symbolic_cut_contradiction (by decide : 0 < 7)
    (reconstructArcs z5.2 z5.1.val) z5.2 C5 (0:Fin 7) (4:Fin 7)
  all_goals decide +kernel
def z6 : Fin 2 × Finset (Sym2 (Fin 7)) := ((0:Fin 2), {s(2,3),s(4,6)})
def C6 : Finset (Fin 7) := {2,3}
theorem z6_not_cycle : ¬ IsSymbolicCycle (by decide : 0 < 7) (reconstructArcs z6.2 z6.1.val) z6.2 := by
  apply symbolic_cut_contradiction (by decide : 0 < 7)
    (reconstructArcs z6.2 z6.1.val) z6.2 C6 (2:Fin 7) (4:Fin 7)
  all_goals decide +kernel
def z7 : Fin 2 × Finset (Sym2 (Fin 7)) := ((1:Fin 2), {s(0,1),s(2,3),s(4,6)})
def C7 : Finset (Fin 7) := {0,1}
theorem z7_not_cycle : ¬ IsSymbolicCycle (by decide : 0 < 7) (reconstructArcs z7.2 z7.1.val) z7.2 := by
  apply symbolic_cut_contradiction (by decide : 0 < 7)
    (reconstructArcs z7.2 z7.1.val) z7.2 C7 (0:Fin 7) (2:Fin 7)
  all_goals decide +kernel
def z8 : Fin 2 × Finset (Sym2 (Fin 7)) := ((1:Fin 2), {s(1,5),s(2,3),s(4,6)})
def C8 : Finset (Fin 7) := {0,1,4,5,6}
theorem z8_not_cycle : ¬ IsSymbolicCycle (by decide : 0 < 7) (reconstructArcs z8.2 z8.1.val) z8.2 := by
  apply symbolic_cut_contradiction (by decide : 0 < 7)
    (reconstructArcs z8.2 z8.1.val) z8.2 C8 (0:Fin 7) (2:Fin 7)
  all_goals decide +kernel
def z9 : Fin 2 × Finset (Sym2 (Fin 7)) := ((0:Fin 2), {s(0,1),s(1,5),s(2,3),s(4,6)})
def C9 : Finset (Fin 7) := {0,1,4,5,6}
theorem z9_not_cycle : ¬ IsSymbolicCycle (by decide : 0 < 7) (reconstructArcs z9.2 z9.1.val) z9.2 := by
  apply symbolic_cut_contradiction (by decide : 0 < 7)
...
theorem infeasible : ¬ ModelFeasible (by decide : 0 < 7) chords :=
  no_model_of_pruned_forms_card (by decide) (by decide) chords bad bad_not_cycle small
end JSP846Seven.R078
#print axioms JSP846Seven.R078.infeasible
namespace JSP846Seven.R079
open JSP846Standard
def chords : Finset (Sym2 (Fin 7)) := {s(0,1),s(0,2),s(1,5),s(2,4),s(3,6)}
...
theorem z0_not_cycle : ¬ IsSymbolicCycle (by decide : 0 < 7) (reconstructArcs z0.2 z0.1.val) z0.2 := by
  apply symbolic_cut_contradiction (by decide : 0 < 7)
    (reconstructArcs z0.2 z0.1.val) z0.2 C0 (0:Fin 7) (2:Fin 7)
  all_goals decide +kernel
def z1 : Fin 2 × Finset (Sym2 (Fin 7)) := ((1:Fin 2), {s(1,5),s(2,4)})
def C1 : Finset (Fin 7) := {0,1,5,6}
theorem z1_not_cycle : ¬ IsSymbolicCycle (by decide : 0 < 7) (reconstructArcs z1.2 z1.1.val) z1.2 := by
  apply symbolic_cut_contradiction (by decide : 0 < 7)
    (reconstructArcs z1.2 z1.1.val) z1.2 C1 (0:Fin 7) (2:Fin 7)
  all_goals decide +kernel
def z2 : Fin 2 × Finset (Sym2 (Fin 7)) := ((0:Fin 2), {s(0,1),s(1,5),s(2,4)})
def C2 : Finset (Fin 7) := {0,1,5,6}
theorem z2_not_cycle : ¬ IsSymbolicCycle (by decide : 0 < 7) (reconstructArcs z2.2 z2.1.val) z2.2 := by
  apply symbolic_cut_contradiction (by decide : 0 < 7)
    (reconstructArcs z2.2 z2.1.val) z2.2 C2 (0:Fin 7) (2:Fin 7)
...
theorem infeasible : ¬ ModelFeasible (by decide : 0 < 7) chords :=
  no_model_of_pruned_forms_card (by decide) (by decide) chords bad bad_not_cycle small
end JSP846Seven.R079
#print axioms JSP846Seven.R079.infeasible
namespace JSP846Seven.R080
open JSP846Standard
def chords : Finset (Sym2 (Fin 7)) := {s(0,1),s(0,2),s(1,5),s(2,6),s(3,4)}
...
theorem z3_not_cycle : ¬ IsSymbolicCycle (by decide : 0 < 7) (reconstructArcs z3.2 z3.1.val) z3.2 := by
  apply symbolic_cut_contradiction (by decide : 0 < 7)
    (reconstructArcs z3.2 z3.1.val) z3.2 C3 (0:Fin 7) (3:Fin 7)
  all_goals decide +kernel
def z4 : Fin 2 × Finset (Sym2 (Fin 7)) := ((1:Fin 2), {s(1,5),s(3,4)})
def C4 : Finset (Fin 7) := {0,1,5,6}
theorem z4_not_cycle : ¬ IsSymbolicCycle (by decide : 0 < 7) (reconstructArcs z4.2 z4.1.val) z4.2 := by
  apply symbolic_cut_contradiction (by decide : 0 < 7)
    (reconstructArcs z4.2 z4.1.val) z4.2 C4 (0:Fin 7) (3:Fin 7)
  all_goals decide +kernel
def z5 : Fin 2 × Finset (Sym2 (Fin 7)) := ((0:Fin 2), {s(0,1),s(1,5),s(3,4)})
def C5 : Finset (Fin 7) := {0,1,5,6}
theorem z5_not_cycle : ¬ IsSymbolicCycle (by decide : 0 < 7) (reconstructArcs z5.2 z5.1.val) z5.2 := by
  apply symbolic_cut_contradiction (by decide : 0 < 7)
    (reconstructArcs z5.2 z5.1.val) z5.2 C5 (0:Fin 7) (3:Fin 7)
  all_goals decide +kernel
def z6 : Fin 2 × Finset (Sym2 (Fin 7)) := ((0:Fin 2), {s(0,2),s(1,5),s(3,4)})
def C6 : Finset (Fin 7) := {0,1,2,5,6}
theorem z6_not_cycle : ¬ IsSymbolicCycle (by decide : 0 < 7) (reconstructArcs z6.2 z6.1.val) z6.2 := by
  apply symbolic_cut_contradiction (by decide : 0 < 7)
    (reconstructArcs z6.2 z6.1.val) z6.2 C6 (0:Fin 7) (3:Fin 7)
  all_goals decide +kernel
def z7 : Fin 2 × Finset (Sym2 (Fin 7)) := ((1:Fin 2), {s(2,6),s(3,4)})
def C7 : Finset (Fin 7) := {0,1,2,6}
theorem z7_not_cycle : ¬ IsSymbolicCycle (by decide : 0 < 7) (reconstructArcs z7.2 z7.1.val) z7.2 := by
  apply symbolic_cut_contradiction (by decide : 0 < 7)
    (reconstructArcs z7.2 z7.1.val) z7.2 C7 (0:Fin 7) (3:Fin 7)
  all_goals decide +kernel
def z8 : Fin 2 × Finset (Sym2 (Fin 7)) := ((0:Fin 2), {s(0,1),s(2,6),s(3,4)})
def C8 : Finset (Fin 7) := {0,1,2,6}
theorem z8_not_cycle : ¬ IsSymbolicCycle (by decide : 0 < 7) (reconstructArcs z8.2 z8.1.val) z8.2 := by
  apply symbolic_cut_contradiction (by decide : 0 < 7)
    (reconstructArcs z8.2 z8.1.val) z8.2 C8 (0:Fin 7) (3:Fin 7)
  all_goals decide +kernel
def z9 : Fin 2 × Finset (Sym2 (Fin 7)) := ((1:Fin 2), {s(0,1),s(2,6),s(3,4)})
def C9 : Finset (Fin 7) := {0,1}
theorem z9_not_cycle : ¬ IsSymbolicCycle (by decide : 0 < 7) (reconstructArcs z9.2 z9.1.val) z9.2 := by
  apply symbolic_cut_contradiction (by decide : 0 < 7)
    (reconstructArcs z9.2 z9.1.val) z9.2 C9 (0:Fin 7) (2:Fin 7)
  all_goals decide +kernel
def z10 : Fin 2 × Finset (Sym2 (Fin 7)) := ((0:Fin 2), {s(0,2),s(2,6),s(3,4)})
def C10 : Finset (Fin 7) := {0,2,6}
theorem z10_not_cycle : ¬ IsSymbolicCycle (by decide : 0 < 7) (reconstructArcs z10.2 z10.1.val) z10.2 := by
  apply symbolic_cut_contradiction (by decide : 0 < 7)
    (reconstructArcs z10.2 z10.1.val) z10.2 C10 (0:Fin 7) (3:Fin 7)
  all_goals decide +kernel
def z11 : Fin 2 × Finset (Sym2 (Fin 7)) := ((0:Fin 2), {s(1,5),s(2,6),s(3,4)})
def C11 : Finset (Fin 7) := {1,2,5,6}
theorem z11_not_cycle : ¬ IsSymbolicCycle (by decide : 0 < 7) (reconstructArcs z11.2 z11.1.val) z11.2 := by
  apply symbolic_cut_contradiction (by decide : 0 < 7)
    (reconstructArcs z11.2 z11.1.val) z11.2 C11 (1:Fin 7) (3:Fin 7)
  all_goals decide +kernel
def z12 : Fin 2 × Finset (Sym2 (Fin 7)) := ((1:Fin 2), {s(0,2),s(1,5),s(2,6),s(3,4)})
def C12 : Finset (Fin 7) := {0,1,2,5,6}
theorem z12_not_cycle : ¬ IsSymbolicCycle (by decide : 0 < 7) (reconstructArcs z12.2 z12.1.val) z12.2 := by
  ...
  all_goals decide +kernel
def z13 : Fin 2 × Finset (Sym2 (Fin 7)) := ((0:Fin 2), {s(0,1),s(0,2),s(1,5),s(2,6),s(3,4)})
def C13 : Finset (Fin 7) := {0,1,2,5,6}
...
theorem infeasible : ¬ ModelFeasible (by decide : 0 < 7) chords :=
  no_model_of_pruned_forms_card (by decide) (by decide) chords bad bad_not_cycle small
end JSP846Seven.R080
#print axioms JSP846Seven.R080.infeasible
