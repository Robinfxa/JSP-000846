...
open JSP846Residual
def chords : Finset (Sym2 (Fin 9)) := {s(0,3),s(0,5),s(1,6),s(2,7),s(4,8)}
def z0 : Fin 2 × Finset (Sym2 (Fin 9)) := ((0:Fin 2), {s(0,3),s(0,5),s(1,6),s(2,7)})
...
def z1 : Fin 2 × Finset (Sym2 (Fin 9)) := ((0:Fin 2), {s(0,3),s(1,6),s(2,7),s(4,8)})
...
theorem z1_not_cycle : ¬ IsSymbolicCycle (by decide : 0 < 9)
  ...
  all_goals decide +kernel
def z2 : Fin 2 × Finset (Sym2 (Fin 9)) := ((0:Fin 2), {s(0,5),s(1,6),s(2,7),s(4,8)})
...
theorem z2_not_cycle : ¬ IsSymbolicCycle (by decide : 0 < 9)
  ...
  all_goals decide +kernel
def z3 : Fin 2 × Finset (Sym2 (Fin 9)) := ((1:Fin 2), {s(0,3),s(4,8)})
...
theorem z3_not_cycle : ¬ IsSymbolicCycle (by decide : 0 < 9)
  ...
  all_goals decide +kernel
def z4 : Fin 2 × Finset (Sym2 (Fin 9)) := ((1:Fin 2), {s(0,5),s(1,6),s(2,7),s(4,8)})
...
def replayForms : List JSP846Replay.Form :=
  JSP846Residual.HintCases.C272.forms.map JSP846HintBridge.exprToForm
end JSP846NineLarge.C272P
#print axioms JSP846NineLarge.C272P.bad_not_cycle
