...
namespace JSP846NineLarge.C277P
open JSP846Standard
open JSP846Replay
open JSP846HintBridge
open JSP846Residual
def chords : Finset (Sym2 (Fin 9)) := {s(0,3),s(0,6),s(1,5),s(2,8),s(4,7)}
...
theorem z3_not_cycle : ¬ IsSymbolicCycle (by decide : 0 < 9)
  ...
  all_goals decide +kernel
def z4 : Fin 2 × Finset (Sym2 (Fin 9)) := ((1:Fin 2), {s(0,6),s(1,5),s(2,8),s(4,7)})
...
def replayForms : List JSP846Replay.Form :=
  JSP846Residual.HintCases.C277.forms.map JSP846HintBridge.exprToForm
...
theorem excluded : ¬ ModelFeasible (by decide : 0 < 9) chords := by
  ...
  have hb : JSP846Residual.Bounds JSP846Residual.HintCases.C277.lower xs := by
    simp [JSP846Residual.HintCases.C277.lower, xs, JSP846HintBridge.finList9,
  ...
  have hc' : JSP846Replay.Covers
      (JSP846Replay.values (JSP846HintBridge.listWeight xs)
        (JSP846Residual.HintCases.C277.forms.map JSP846HintBridge.exprToForm)) := by
    have hwEq := JSP846HintBridge.listWeight_finList9 w
    rw [hwEq]
    simpa [replayForms] using hc
  have ho : JSP846Residual.OriginalFeasible
      JSP846Residual.HintCases.C277.lower
      JSP846Residual.HintCases.C277.forms :=
    JSP846HintBridge.originalFeasible_of_replay
      JSP846Residual.HintCases.C277.lower
      JSP846Residual.HintCases.C277.forms xs hb hs hc'
  exact JSP846Residual.HintCases.C277.infeasible ho
end JSP846NineLarge.C277P
#print axioms JSP846NineLarge.C277P.pruned_subset
#print axioms JSP846NineLarge.C277P.excluded
