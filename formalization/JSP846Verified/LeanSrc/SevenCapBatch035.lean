...
namespace JSP846Seven.R189
open JSP846Standard
def chords : Finset (Sym2 (Fin 7)) := {s(0,1),s(0,3),s(2,4),s(2,5),s(5,6)}
...
end JSP846Seven.R189
#print axioms JSP846Seven.R189.infeasible
namespace JSP846Seven.R190
open JSP846Standard
def chords : Finset (Sym2 (Fin 7)) := {s(0,1),s(0,3),s(2,4),s(2,6),s(3,5)}
def z0 : Fin 2 × Finset (Sym2 (Fin 7)) := ((1:Fin 2), {s(0,1),s(2,4)})
def C0 : Finset (Fin 7) := {0,1}
theorem z0_not_cycle : ¬ IsSymbolicCycle (by decide : 0 < 7) (reconstructArcs z0.2 z0.1.val) z0.2 := by
  apply symbolic_cut_contradiction (by decide : 0 < 7)
...
theorem infeasible : ¬ ModelFeasible (by decide : 0 < 7) chords :=
  no_model_of_pruned_forms_card (by decide) (by decide) chords bad bad_not_cycle small
end JSP846Seven.R190
#print axioms JSP846Seven.R190.infeasible
namespace JSP846Seven.R191
open JSP846Standard
def chords : Finset (Sym2 (Fin 7)) := {s(0,1),s(0,3),s(2,4),s(2,6),s(4,5)}
def z0 : Fin 2 × Finset (Sym2 (Fin 7)) := ((1:Fin 2), {s(0,1),s(2,4)})
def C0 : Finset (Fin 7) := {0,1}
theorem z0_not_cycle : ¬ IsSymbolicCycle (by decide : 0 < 7) (reconstructArcs z0.2 z0.1.val) z0.2 := by
  apply symbolic_cut_contradiction (by decide : 0 < 7)
...
theorem z9_not_cycle : ¬ IsSymbolicCycle (by decide : 0 < 7) (reconstructArcs z9.2 z9.1.val) z9.2 := by
  ...
  all_goals decide +kernel
def z10 : Fin 2 × Finset (Sym2 (Fin 7)) := ((1:Fin 2), {s(0,1),s(2,4),s(2,6),s(4,5)})
...
theorem infeasible : ¬ ModelFeasible (by decide : 0 < 7) chords :=
  no_model_of_pruned_forms_card (by decide) (by decide) chords bad bad_not_cycle small
end JSP846Seven.R191
#print axioms JSP846Seven.R191.infeasible
namespace JSP846Seven.R192
open JSP846Standard
def chords : Finset (Sym2 (Fin 7)) := {s(0,1),s(0,3),s(2,4),s(2,6),s(5,6)}
def z0 : Fin 2 × Finset (Sym2 (Fin 7)) := ((1:Fin 2), {s(0,1),s(2,4)})
def C0 : Finset (Fin 7) := {0,1}
theorem z0_not_cycle : ¬ IsSymbolicCycle (by decide : 0 < 7) (reconstructArcs z0.2 z0.1.val) z0.2 := by
  apply symbolic_cut_contradiction (by decide : 0 < 7)
...
theorem z9_not_cycle : ¬ IsSymbolicCycle (by decide : 0 < 7) (reconstructArcs z9.2 z9.1.val) z9.2 := by
  apply symbolic_cut_contradiction (by decide : 0 < 7)
    (reconstructArcs z9.2 z9.1.val) z9.2 C9 (0:Fin 7) (5:Fin 7)
  all_goals decide +kernel
def z10 : Fin 2 × Finset (Sym2 (Fin 7)) := ((1:Fin 2), {s(0,1),s(2,6),s(5,6)})
def C10 : Finset (Fin 7) := {0,1}
theorem z10_not_cycle : ¬ IsSymbolicCycle (by decide : 0 < 7) (reconstructArcs z10.2 z10.1.val) z10.2 := by
  apply symbolic_cut_contradiction (by decide : 0 < 7)
    (reconstructArcs z10.2 z10.1.val) z10.2 C10 (0:Fin 7) (2:Fin 7)
  all_goals decide +kernel
def z11 : Fin 2 × Finset (Sym2 (Fin 7)) := ((1:Fin 2), {s(0,1),s(2,4),s(2,6),s(5,6)})
...
theorem infeasible : ¬ ModelFeasible (by decide : 0 < 7) chords :=
  no_model_of_pruned_forms_card (by decide) (by decide) chords bad bad_not_cycle small
end JSP846Seven.R192
#print axioms JSP846Seven.R192.infeasible
namespace JSP846Seven.R193
open JSP846Standard
def chords : Finset (Sym2 (Fin 7)) := {s(0,1),s(0,3),s(2,4),s(3,5),s(3,6)}
def z0 : Fin 2 × Finset (Sym2 (Fin 7)) := ((1:Fin 2), {s(0,1),s(2,4)})
def C0 : Finset (Fin 7) := {0,1}
theorem z0_not_cycle : ¬ IsSymbolicCycle (by decide : 0 < 7) (reconstructArcs z0.2 z0.1.val) z0.2 := by
  apply symbolic_cut_contradiction (by decide : 0 < 7)
...
theorem z4_not_cycle : ¬ IsSymbolicCycle (by decide : 0 < 7) (reconstructArcs z4.2 z4.1.val) z4.2 := by
  apply symbolic_cut_contradiction (by decide : 0 < 7)
    (reconstructArcs z4.2 z4.1.val) z4.2 C4 (0:Fin 7) (2:Fin 7)
  all_goals decide +kernel
def z5 : Fin 2 × Finset (Sym2 (Fin 7)) := ((1:Fin 2), {s(0,1),s(3,5),s(3,6)})
...
theorem infeasible : ¬ ModelFeasible (by decide : 0 < 7) chords :=
  no_model_of_pruned_forms_card (by decide) (by decide) chords bad bad_not_cycle small
end JSP846Seven.R193
#print axioms JSP846Seven.R193.infeasible
