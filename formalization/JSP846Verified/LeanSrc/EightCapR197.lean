...
namespace JSP846Eight.R197
open JSP846Standard
def chords : Finset (Sym2 (Fin 8)) := {s(0,1),s(0,5),s(0,6),s(2,4),s(3,7)}
...
theorem z2_not_cycle : ¬ IsSymbolicCycle (by decide : 0 < 8) (reconstructArcs z2.2 z2.1.val) z2.2 := by
  ...
  all_goals decide +kernel
def z3 : Fin 2 × Finset (Sym2 (Fin 8)) := ((0:Fin 2), {s(0,5),s(0,6),s(2,4)})
...
end JSP846Eight.R197
#print axioms JSP846Eight.R197.infeasible
