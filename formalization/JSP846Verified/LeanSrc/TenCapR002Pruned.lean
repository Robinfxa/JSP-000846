...
namespace JSP846TenCap.R002
open JSP846Standard
def chords : Finset (Sym2 (Fin 10)) := {s(0,1),s(2,3),s(4,5),s(6,9),s(7,8)}
...
def z1 : Fin 2 × Finset (Sym2 (Fin 10)) := ((1:Fin 2), {s(0,1),s(4,5)})
...
theorem z1_not_cycle : ¬ IsSymbolicCycle (by decide : 0 < 10)
  ...
  all_goals decide +kernel
def z2 : Fin 2 × Finset (Sym2 (Fin 10)) := ((0:Fin 2), {s(2,3),s(4,5)})
...
theorem z2_not_cycle : ¬ IsSymbolicCycle (by decide : 0 < 10)
  ...
  all_goals decide +kernel
def z3 : Fin 2 × Finset (Sym2 (Fin 10)) := ((1:Fin 2), {s(0,1),s(2,3),s(4,5)})
...
theorem z3_not_cycle : ¬ IsSymbolicCycle (by decide : 0 < 10)
  ...
  all_goals decide +kernel
def z4 : Fin 2 × Finset (Sym2 (Fin 10)) := ((1:Fin 2), {s(0,1),s(6,9)})
def C4 : Finset (Fin 10) := {0,1}
theorem z4_not_cycle : ¬ IsSymbolicCycle (by decide : 0 < 10)
    (reconstructArcs z4.2 z4.1.val) z4.2 := by
  apply symbolic_cut_contradiction (by decide : 0 < 10)
    (reconstructArcs z4.2 z4.1.val) z4.2 C4 (0:Fin 10) (6:Fin 10)
  all_goals decide +kernel
def z5 : Fin 2 × Finset (Sym2 (Fin 10)) := ((0:Fin 2), {s(2,3),s(6,9)})
def C5 : Finset (Fin 10) := {2,3}
theorem z5_not_cycle : ¬ IsSymbolicCycle (by decide : 0 < 10)
    (reconstructArcs z5.2 z5.1.val) z5.2 := by
  apply symbolic_cut_contradiction (by decide : 0 < 10)
    (reconstructArcs z5.2 z5.1.val) z5.2 C5 (2:Fin 10) (6:Fin 10)
  all_goals decide +kernel
def z6 : Fin 2 × Finset (Sym2 (Fin 10)) := ((1:Fin 2), {s(0,1),s(2,3),s(6,9)})
...
theorem z6_not_cycle : ¬ IsSymbolicCycle (by decide : 0 < 10)
  ...
  all_goals decide +kernel
def z7 : Fin 2 × Finset (Sym2 (Fin 10)) := ((0:Fin 2), {s(4,5),s(6,9)})
def C7 : Finset (Fin 10) := {4,5}
theorem z7_not_cycle : ¬ IsSymbolicCycle (by decide : 0 < 10)
    (reconstructArcs z7.2 z7.1.val) z7.2 := by
  apply symbolic_cut_contradiction (by decide : 0 < 10)
    (reconstructArcs z7.2 z7.1.val) z7.2 C7 (4:Fin 10) (6:Fin 10)
  all_goals decide +kernel
def z8 : Fin 2 × Finset (Sym2 (Fin 10)) := ((1:Fin 2), {s(0,1),s(4,5),s(6,9)})
...
theorem z8_not_cycle : ¬ IsSymbolicCycle (by decide : 0 < 10)
  ...
  all_goals decide +kernel
def z9 : Fin 2 × Finset (Sym2 (Fin 10)) := ((0:Fin 2), {s(2,3),s(4,5),s(6,9)})
def C9 : Finset (Fin 10) := {2,3}
theorem z9_not_cycle : ¬ IsSymbolicCycle (by decide : 0 < 10)
    (reconstructArcs z9.2 z9.1.val) z9.2 := by
  apply symbolic_cut_contradiction (by decide : 0 < 10)
    (reconstructArcs z9.2 z9.1.val) z9.2 C9 (2:Fin 10) (4:Fin 10)
  all_goals decide +kernel
def z10 : Fin 2 × Finset (Sym2 (Fin 10)) := ((1:Fin 2), {s(0,1),s(2,3),s(4,5),s(6,9)})
def C10 : Finset (Fin 10) := {0,1}
theorem z10_not_cycle : ¬ IsSymbolicCycle (by decide : 0 < 10)
    (reconstructArcs z10.2 z10.1.val) z10.2 := by
  apply symbolic_cut_contradiction (by decide : 0 < 10)
    (reconstructArcs z10.2 z10.1.val) z10.2 C10 (0:Fin 10) (2:Fin 10)
  all_goals decide +kernel
def z11 : Fin 2 × Finset (Sym2 (Fin 10)) := ((1:Fin 2), {s(0,1),s(7,8)})
def C11 : Finset (Fin 10) := {0,1}
theorem z11_not_cycle : ¬ IsSymbolicCycle (by decide : 0 < 10)
    (reconstructArcs z11.2 z11.1.val) z11.2 := by
  apply symbolic_cut_contradiction (by decide : 0 < 10)
    (reconstructArcs z11.2 z11.1.val) z11.2 C11 (0:Fin 10) (7:Fin 10)
  all_goals decide +kernel
def z12 : Fin 2 × Finset (Sym2 (Fin 10)) := ((0:Fin 2), {s(2,3),s(7,8)})
def C12 : Finset (Fin 10) := {2,3}
theorem z12_not_cycle : ¬ IsSymbolicCycle (by decide : 0 < 10)
    (reconstructArcs z12.2 z12.1.val) z12.2 := by
  apply symbolic_cut_contradiction (by decide : 0 < 10)
    (reconstructArcs z12.2 z12.1.val) z12.2 C12 (2:Fin 10) (7:Fin 10)
  all_goals decide +kernel
def z13 : Fin 2 × Finset (Sym2 (Fin 10)) := ((1:Fin 2), {s(0,1),s(2,3),s(7,8)})
...
theorem z13_not_cycle : ¬ IsSymbolicCycle (by decide : 0 < 10)
  ...
  all_goals decide +kernel
def z14 : Fin 2 × Finset (Sym2 (Fin 10)) := ((0:Fin 2), {s(4,5),s(7,8)})
def C14 : Finset (Fin 10) := {4,5}
theorem z14_not_cycle : ¬ IsSymbolicCycle (by decide : 0 < 10)
    (reconstructArcs z14.2 z14.1.val) z14.2 := by
  apply symbolic_cut_contradiction (by decide : 0 < 10)
    (reconstructArcs z14.2 z14.1.val) z14.2 C14 (4:Fin 10) (7:Fin 10)
  all_goals decide +kernel
def z15 : Fin 2 × Finset (Sym2 (Fin 10)) := ((1:Fin 2), {s(0,1),s(4,5),s(7,8)})
def C15 : Finset (Fin 10) := {0,1}
theorem z15_not_cycle : ¬ IsSymbolicCycle (by decide : 0 < 10)
    (reconstructArcs z15.2 z15.1.val) z15.2 := by
  apply symbolic_cut_contradiction (by decide : 0 < 10)
    (reconstructArcs z15.2 z15.1.val) z15.2 C15 (0:Fin 10) (4:Fin 10)
  all_goals decide +kernel
def z16 : Fin 2 × Finset (Sym2 (Fin 10)) := ((0:Fin 2), {s(2,3),s(4,5),s(7,8)})
def C16 : Finset (Fin 10) := {2,3}
theorem z16_not_cycle : ¬ IsSymbolicCycle (by decide : 0 < 10)
    (reconstructArcs z16.2 z16.1.val) z16.2 := by
  apply symbolic_cut_contradiction (by decide : 0 < 10)
    (reconstructArcs z16.2 z16.1.val) z16.2 C16 (2:Fin 10) (4:Fin 10)
  all_goals decide +kernel
def z17 : Fin 2 × Finset (Sym2 (Fin 10)) := ((1:Fin 2), {s(0,1),s(2,3),s(4,5),s(7,8)})
def C17 : Finset (Fin 10) := {0,1}
theorem z17_not_cycle : ¬ IsSymbolicCycle (by decide : 0 < 10)
    (reconstructArcs z17.2 z17.1.val) z17.2 := by
  apply symbolic_cut_contradiction (by decide : 0 < 10)
    (reconstructArcs z17.2 z17.1.val) z17.2 C17 (0:Fin 10) (2:Fin 10)
  all_goals decide +kernel
def z18 : Fin 2 × Finset (Sym2 (Fin 10)) := ((1:Fin 2), {s(6,9),s(7,8)})
def C18 : Finset (Fin 10) := {0,1,2,3,4,5,6,9}
theorem z18_not_cycle : ¬ IsSymbolicCycle (by decide : 0 < 10)
    (reconstructArcs z18.2 z18.1.val) z18.2 := by
  apply symbolic_cut_contradiction (by decide : 0 < 10)
    (reconstructArcs z18.2 z18.1.val) z18.2 C18 (0:Fin 10) (7:Fin 10)
  all_goals decide +kernel
def z19 : Fin 2 × Finset (Sym2 (Fin 10)) := ((0:Fin 2), {s(0,1),s(6,9),s(7,8)})
def C19 : Finset (Fin 10) := {0,1,2,3,4,5,6,9}
theorem z19_not_cycle : ¬ IsSymbolicCycle (by decide : 0 < 10)
    (reconstructArcs z19.2 z19.1.val) z19.2 := by
  apply symbolic_cut_contradiction (by decide : 0 < 10)
    (reconstructArcs z19.2 z19.1.val) z19.2 C19 (0:Fin 10) (7:Fin 10)
  all_goals decide +kernel
def z20 : Fin 2 × Finset (Sym2 (Fin 10)) := ((1:Fin 2), {s(0,1),s(6,9),s(7,8)})
...
theorem z20_not_cycle : ¬ IsSymbolicCycle (by decide : 0 < 10)
  ...
  all_goals decide +kernel
def z21 : Fin 2 × Finset (Sym2 (Fin 10)) := ((0:Fin 2), {s(2,3),s(6,9),s(7,8)})
def C21 : Finset (Fin 10) := {2,3}
theorem z21_not_cycle : ¬ IsSymbolicCycle (by decide : 0 < 10)
    (reconstructArcs z21.2 z21.1.val) z21.2 := by
  apply symbolic_cut_contradiction (by decide : 0 < 10)
    (reconstructArcs z21.2 z21.1.val) z21.2 C21 (2:Fin 10) (6:Fin 10)
  all_goals decide +kernel
def z22 : Fin 2 × Finset (Sym2 (Fin 10)) := ((1:Fin 2), {s(2,3),s(6,9),s(7,8)})
def C22 : Finset (Fin 10) := {0,1,2,3,4,5,6,9}
theorem z22_not_cycle : ¬ IsSymbolicCycle (by decide : 0 < 10)
    (reconstructArcs z22.2 z22.1.val) z22.2 := by
  apply symbolic_cut_contradiction (by decide : 0 < 10)
    (reconstructArcs z22.2 z22.1.val) z22.2 C22 (0:Fin 10) (7:Fin 10)
  all_goals decide +kernel
def z23 : Fin 2 × Finset (Sym2 (Fin 10)) := ((0:Fin 2), {s(0,1),s(2,3),s(6,9),s(7,8)})
...
theorem z23_not_cycle : ¬ IsSymbolicCycle (by decide : 0 < 10)
  ...
  all_goals decide +kernel
def z24 : Fin 2 × Finset (Sym2 (Fin 10)) := ((1:Fin 2), {s(0,1),s(2,3),s(6,9),s(7,8)})
def C24 : Finset (Fin 10) := {0,1}
theorem z24_not_cycle : ¬ IsSymbolicCycle (by decide : 0 < 10)
    (reconstructArcs z24.2 z24.1.val) z24.2 := by
  apply symbolic_cut_contradiction (by decide : 0 < 10)
    (reconstructArcs z24.2 z24.1.val) z24.2 C24 (0:Fin 10) (2:Fin 10)
  all_goals decide +kernel
def z25 : Fin 2 × Finset (Sym2 (Fin 10)) := ((0:Fin 2), {s(4,5),s(6,9),s(7,8)})
def C25 : Finset (Fin 10) := {4,5}
theorem z25_not_cycle : ¬ IsSymbolicCycle (by decide : 0 < 10)
    (reconstructArcs z25.2 z25.1.val) z25.2 := by
  apply symbolic_cut_contradiction (by decide : 0 < 10)
    (reconstructArcs z25.2 z25.1.val) z25.2 C25 (4:Fin 10) (6:Fin 10)
  all_goals decide +kernel
def z26 : Fin 2 × Finset (Sym2 (Fin 10)) := ((1:Fin 2), {s(4,5),s(6,9),s(7,8)})
def C26 : Finset (Fin 10) := {0,1,2,3,4,5,6,9}
theorem z26_not_cycle : ¬ IsSymbolicCycle (by decide : 0 < 10)
    (reconstructArcs z26.2 z26.1.val) z26.2 := by
  apply symbolic_cut_contradiction (by decide : 0 < 10)
    (reconstructArcs z26.2 z26.1.val) z26.2 C26 (0:Fin 10) (7:Fin 10)
  all_goals decide +kernel
def z27 : Fin 2 × Finset (Sym2 (Fin 10)) := ((0:Fin 2), {s(0,1),s(4,5),s(6,9),s(7,8)})
def C27 : Finset (Fin 10) := {0,1,2,3,4,5,6,9}
theorem z27_not_cycle : ¬ IsSymbolicCycle (by decide : 0 < 10)
  ...
  all_goals decide +kernel
def z28 : Fin 2 × Finset (Sym2 (Fin 10)) := ((1:Fin 2), {s(0,1),s(4,5),s(6,9),s(7,8)})
...
theorem z28_not_cycle : ¬ IsSymbolicCycle (by decide : 0 < 10)
  ...
  all_goals decide +kernel
def z29 : Fin 2 × Finset (Sym2 (Fin 10)) := ((0:Fin 2), {s(2,3),s(4,5),s(6,9),s(7,8)})
def C29 : Finset (Fin 10) := {2,3}
theorem z29_not_cycle : ¬ IsSymbolicCycle (by decide : 0 < 10)
    (reconstructArcs z29.2 z29.1.val) z29.2 := by
  apply symbolic_cut_contradiction (by decide : 0 < 10)
    (reconstructArcs z29.2 z29.1.val) z29.2 C29 (2:Fin 10) (4:Fin 10)
  all_goals decide +kernel
def z30 : Fin 2 × Finset (Sym2 (Fin 10)) := ((1:Fin 2), {s(2,3),s(4,5),s(6,9),s(7,8)})
def C30 : Finset (Fin 10) := {0,1,2,3,4,5,6,9}
theorem z30_not_cycle : ¬ IsSymbolicCycle (by decide : 0 < 10)
    (reconstructArcs z30.2 z30.1.val) z30.2 := by
  apply symbolic_cut_contradiction (by decide : 0 < 10)
    (reconstructArcs z30.2 z30.1.val) z30.2 C30 (0:Fin 10) (7:Fin 10)
  all_goals decide +kernel
def z31 : Fin 2 × Finset (Sym2 (Fin 10)) := ((0:Fin 2), {s(0,1),s(2,3),s(4,5),s(6,9),s(7,8)})
...
theorem z31_not_cycle : ¬ IsSymbolicCycle (by decide : 0 < 10)
  ...
  all_goals decide +kernel
def z32 : Fin 2 × Finset (Sym2 (Fin 10)) := ((1:Fin 2), {s(0,1),s(2,3),s(4,5),s(6,9),s(7,8)})
def C32 : Finset (Fin 10) := {0,1}
theorem z32_not_cycle : ¬ IsSymbolicCycle (by decide : 0 < 10)
    (reconstructArcs z32.2 z32.1.val) z32.2 := by
  apply symbolic_cut_contradiction (by decide : 0 < 10)
    (reconstructArcs z32.2 z32.1.val) z32.2 C32 (0:Fin 10) (2:Fin 10)
  all_goals decide +kernel
...
theorem rep_eq : tenRepAt (2:Fin 79) = chords := by decide +kernel
theorem rep_excluded : ¬ ModelFeasible (by decide : 0 < 10) (tenRepAt (2:Fin 79)) := by
  rw [rep_eq]
  exact excluded
end JSP846TenCap.R002
#print axioms JSP846TenCap.R002.small
#print axioms JSP846TenCap.R002.rep_excluded
