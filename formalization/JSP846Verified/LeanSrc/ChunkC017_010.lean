import ChunkC017_009
set_option autoImplicit false
set_option maxRecDepth 100000
set_option maxHeartbeats 8000000
namespace JSP846DAG.C017
open JSP846Replay
def fs_69793218563 : List Form := [(4,[]),(3,[1]),(3,[2,3]),(5,[4]),(7,[4]),(6,[1,4]),(8,[1,4]),(6,[2,3,4]),(8,[2,3,4]),(7,[1,2,3,4]),(9,[1,2,3,4]),(6,[2]),(8,[2]),(7,[1,2]),(9,[1,2]),(7,[3]),(9,[3]),(8,[1,3]),(10,[1,3]),(5,[2,4]),(4,[3,4]),(5,[2]),(7,[2]),(6,[1,2]),(8,[1,2]),(6,[3]),(8,[3]),(7,[1,3]),(9,[1,3]),(6,[2,4]),(5,[3,4]),(3,[]),(6,[4]),(8,[4]),(7,[1,4]),(9,[1,4]),(7,[2,3,4]),(9,[2,3,4]),(8,[1,2,3,4]),(10,[1,2,3,4])]

theorem node_69793218563 (x : Nat → Nat) (hs : x 1 + (x 2 + (x 3 + (x 4 + (0)))) = 31)
    (hc : Covers (values x fs_69793218563)) : False := by

  have hm := hc 5 (by decide) (by decide)

  have hopts : (x 1 + (0) = 2) ∨ (x 2 + (0) = 0) ∨ (x 2 + (x 3 + (0)) = 2) ∨ (x 2 + (x 4 + (0)) = 0) ∨ (x 3 + (x 4 + (0)) = 0) ∨ (x 3 + (x 4 + (0)) = 1) ∨ (x 4 + (0) = 0) := by
  ...
  · have hchoices : (x 1 = 2) := by
    ...
    change Covers (values x fs_69793218819) at hchild

    exact node_69793218819 x (by omega) hchild
