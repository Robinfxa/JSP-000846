import MicroC253_092
set_option autoImplicit false
set_option maxRecDepth 100000
set_option maxHeartbeats 8000000
namespace JSP846DAG.C253
open JSP846Replay
def fs_285873039999105 : List Form := [(4,[]),(6,[2,3]),(6,[2,3]),(6,[2,5]),(6,[2,5]),(4,[3,5]),(5,[2,6]),(7,[2,6]),(7,[3,6]),(9,[3,6]),(5,[5,6]),(7,[5,6]),(7,[2,3,5,6]),(9,[2,3,5,6]),(6,[2,3]),(8,[2,3]),(6,[]),(8,[]),(8,[3,5]),(10,[3,5]),(8,[2,5]),(10,[2,5]),(5,[3,6]),(9,[2,6]),(9,[2,6]),(9,[2,3,5,6]),(9,[2,3,5,6]),(5,[5,6]),(5,[2,3]),(7,[2,3]),(5,[]),(7,[]),(7,[3,5]),(9,[3,5]),(7,[2,5]),(9,[2,5]),(6,[3,6]),(10,[2,6]),(10,[2,3,5,6]),(6,[5,6]),(3,[]),(6,[2,6]),(8,[2,6]),(8,[3,6]),(10,[3,6]),(6,[5,6]),(8,[5,6]),(8,[2,3,5,6]),(10,[2,3,5,6])]
...
theorem node_285873039999105 (x : Nat → Nat) (hs : x 2 + (x 3 + (x 5 + (x 6 + (0)))) = 31)
  ...
  have hopts : (x 2 + (x 3 + (0)) = 0) ∨ (x 2 + (x 3 + (0)) = 1) ∨ (x 2 + (x 3 + (0)) = 2) ∨ (x 2 + (x 5 + (0)) = 0) ∨ (x 2 + (x 5 + (0)) = 1) ∨ (x 2 + (x 5 + (0)) = 2) ∨ (x 2 + (x 5 + (0)) = 3) ∨ (x 2 + (x 5 + (0)) = 4) ∨ (x 2 + (x 6 + (0)) = 1) ∨ (x 2 + (x 6 + (0)) = 2) ∨ (x 2 + (x 6 + (0)) = 3) ∨ (x 2 + (x 6 + (0)) = 4) ∨ (x 3 + (x 5 + (0)) = 0) ∨ (x 3 + (x 5 + (0)) = 1) ∨ (x 3 + (x 5 + (0)) = 2) ∨ (x 3 + (x 5 + (0)) = 3) ∨ (x 3 + (x 5 + (0)) = 4) ∨ (x 3 + (x 6 + (0)) = 0) ∨ (x 3 + (x 6 + (0)) = 1) ∨ (x 3 + (x 6 + (0)) = 2) ∨ (x 3 + (x 6 + (0)) = 3) ∨ (x 3 + (x 6 + (0)) = 4) ∨ (x 5 + (x 6 + (0)) = 0) ∨ (x 5 + (x 6 + (0)) = 1) ∨ (x 5 + (x 6 + (0)) = 2) := by
  ...
  · have hchoices : (x 2 = 0 ∧ x 5 = 4) ∨ (x 2 = 1 ∧ x 5 = 3) ∨ (x 2 = 2 ∧ x 5 = 2) ∨ (x 2 = 3 ∧ x 5 = 1) ∨ (x 2 = 4 ∧ x 5 = 0) := by
    ...
    · have hchild := hc
      ...
      change Covers (values x fs_285878408712321) at hchild

      exact node_285878408712321 x (by omega) hchild
    ...
    · have hchild := hc
      ...
      change Covers (values x fs_285877334974593) at hchild

      exact node_285877334974593 x (by omega) hchild
    ...
    · have hchild := hc
      ...
      change Covers (values x fs_285876261236865) at hchild

      exact node_285876261236865 x (by omega) hchild
    ...
    · have hchild := hc
      ...
      change Covers (values x fs_285875187499137) at hchild

      exact node_285875187499137 x (by omega) hchild
    ...
    · have hchild := hc
      ...
      change Covers (values x fs_285874113761409) at hchild

      exact node_285874113761409 x (by omega) hchild
  ...
  · have hchoices : (x 3 = 0 ∧ x 6 = 4) ∨ (x 3 = 1 ∧ x 6 = 3) ∨ (x 3 = 2 ∧ x 6 = 2) ∨ (x 3 = 3 ∧ x 6 = 1) ∨ (x 3 = 4 ∧ x 6 = 0) := by
    ...
    · have hchild := hc
      ...
      change Covers (values x fs_286216637644929) at hchild

      exact node_286216637644929 x (by omega) hchild
    ...
    · have hchild := hc
      ...
      change Covers (values x fs_286147918430337) at hchild

      exact node_286147918430337 x (by omega) hchild
    ...
    · have hchild := hc
      ...
      change Covers (values x fs_286079199215745) at hchild

      exact node_286079199215745 x (by omega) hchild
    ...
    · have hchild := hc
      ...
      change Covers (values x fs_286010480001153) at hchild

      exact node_286010480001153 x (by omega) hchild
    ...
    · have hchild := hc
      ...
      change Covers (values x fs_285941760786561) at hchild

      exact node_285941760786561 x (by omega) hchild
