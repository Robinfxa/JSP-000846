...
namespace JSP846Seven.R311
open JSP846Standard
def chords : Finset (Sym2 (Fin 7)) := {s(0,2),s(0,3),s(1,4),s(3,5),s(4,6)}
...
theorem z3_not_cycle : ¬ IsSymbolicCycle (by decide : 0 < 7) (reconstructArcs z3.2 z3.1.val) z3.2 := by
  ...
  all_goals decide +kernel
def z4 : Fin 2 × Finset (Sym2 (Fin 7)) := ((1:Fin 2), {s(0,2),s(3,5),s(4,6)})
...
end JSP846Seven.R311
#print axioms JSP846Seven.R311.infeasible
namespace JSP846Seven.R316
open JSP846Standard
def chords : Finset (Sym2 (Fin 7)) := {s(0,2),s(0,3),s(1,5),s(3,5),s(4,6)}
def z0 : Fin 2 × Finset (Sym2 (Fin 7)) := ((1:Fin 2), {s(0,2),s(3,5)})
def C0 : Finset (Fin 7) := {0,1,2}
theorem z0_not_cycle : ¬ IsSymbolicCycle (by decide : 0 < 7) (reconstructArcs z0.2 z0.1.val) z0.2 := by
  apply symbolic_cut_contradiction (by decide : 0 < 7)
...
theorem infeasible : ¬ ModelFeasible (by decide : 0 < 7) chords :=
  no_model_of_pruned_forms_card (by decide) (by decide) chords bad bad_not_cycle small
end JSP846Seven.R316
#print axioms JSP846Seven.R316.infeasible
namespace JSP846Seven.R320
open JSP846Standard
def chords : Finset (Sym2 (Fin 7)) := {s(0,2),s(0,3),s(1,6),s(3,5),s(4,6)}
def z0 : Fin 2 × Finset (Sym2 (Fin 7)) := ((1:Fin 2), {s(0,2),s(3,5)})
def C0 : Finset (Fin 7) := {0,1,2}
theorem z0_not_cycle : ¬ IsSymbolicCycle (by decide : 0 < 7) (reconstructArcs z0.2 z0.1.val) z0.2 := by
  apply symbolic_cut_contradiction (by decide : 0 < 7)
...
theorem z5_not_cycle : ¬ IsSymbolicCycle (by decide : 0 < 7) (reconstructArcs z5.2 z5.1.val) z5.2 := by
  ...
  all_goals decide +kernel
def z6 : Fin 2 × Finset (Sym2 (Fin 7)) := ((1:Fin 2), {s(0,2),s(3,5),s(4,6)})
...
theorem infeasible : ¬ ModelFeasible (by decide : 0 < 7) chords :=
  no_model_of_pruned_forms_card (by decide) (by decide) chords bad bad_not_cycle small
end JSP846Seven.R320
#print axioms JSP846Seven.R320.infeasible
namespace JSP846Seven.R330
open JSP846Standard
def chords : Finset (Sym2 (Fin 7)) := {s(0,2),s(0,5),s(1,3),s(2,4),s(4,6)}
...
theorem z1_not_cycle : ¬ IsSymbolicCycle (by decide : 0 < 7) (reconstructArcs z1.2 z1.1.val) z1.2 := by
  ...
  all_goals decide +kernel
def z2 : Fin 2 × Finset (Sym2 (Fin 7)) := ((0:Fin 2), {s(0,5),s(1,3),s(2,4)})
...
theorem infeasible : ¬ ModelFeasible (by decide : 0 < 7) chords :=
  no_model_of_pruned_forms_card (by decide) (by decide) chords bad bad_not_cycle small
end JSP846Seven.R330
#print axioms JSP846Seven.R330.infeasible
