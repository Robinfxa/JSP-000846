import MicroC011_095
set_option autoImplicit false
set_option maxRecDepth 100000
set_option maxHeartbeats 8000000
namespace JSP846DAG.C011
open JSP846Replay
def fs_16777410 : List Form := [(3,[]),(4,[]),(5,[2,3]),(6,[2,3]),(7,[2,3]),(8,[2,3]),(5,[]),(6,[]),(7,[]),(8,[]),(4,[2,3]),(4,[2,5]),(7,[3,5]),(8,[3,5]),(9,[3,5]),(10,[3,5]),(7,[2,5]),(8,[2,5]),(9,[2,5]),(10,[2,5]),(4,[3,5]),(5,[2,6]),(6,[2,6]),(7,[2,6]),(8,[2,6]),(4,[3,6]),(6,[2,6]),(7,[3,6]),(8,[3,6]),(9,[3,6]),(10,[3,6]),(5,[5,6]),(6,[5,6]),(7,[5,6]),(8,[5,6]),(6,[2,3,5,6]),(4,[5,6]),(7,[2,3,5,6]),(8,[2,3,5,6]),(9,[2,3,5,6]),(10,[2,3,5,6])]
...
theorem node_16777410 (x : Nat → Nat) (hs : x 2 + (x 3 + (x 5 + (x 6 + (0)))) = 31)
  ...
  · have hchoices : (x 2 = 0 ∧ x 5 = 4) ∨ (x 2 = 1 ∧ x 5 = 3) ∨ (x 2 = 2 ∧ x 5 = 2) ∨ (x 2 = 3 ∧ x 5 = 1) ∨ (x 2 = 4 ∧ x 5 = 0) := by
    ...
    · have hchild := hc
      ...
      change Covers (values x fs_5385490626) at hchild

      exact node_5385490626 x (by omega) hchild
    ...
    · have hchild := hc
      ...
      change Covers (values x fs_4311752898) at hchild

      exact node_4311752898 x (by omega) hchild
    ...
    · have hchild := hc
      ...
      change Covers (values x fs_3238015170) at hchild

      exact node_3238015170 x (by omega) hchild
    ...
    · have hchild := hc
      ...
      change Covers (values x fs_2164277442) at hchild

      exact node_2164277442 x (by omega) hchild
    ...
    · have hchild := hc
      ...
      change Covers (values x fs_1090539714) at hchild

      exact node_1090539714 x (by omega) hchild
  ...
  · have hchoices : (x 2 = 0 ∧ x 5 = 5) ∨ (x 2 = 1 ∧ x 5 = 4) ∨ (x 2 = 2 ∧ x 5 = 3) ∨ (x 2 = 3 ∧ x 5 = 2) ∨ (x 2 = 4 ∧ x 5 = 1) ∨ (x 2 = 5 ∧ x 5 = 0) := by
    ...
    · have hchild := hc
      ...
      change Covers (values x fs_6459232450) at hchild

      exact node_6459232450 x (by omega) hchild
    ...
    · have hchild := hc
      ...
      change Covers (values x fs_5385494722) at hchild

      exact node_5385494722 x (by omega) hchild
    ...
    · have hchild := hc
      ...
      change Covers (values x fs_4311756994) at hchild

      exact node_4311756994 x (by omega) hchild
    ...
    · have hchild := hc
      ...
      change Covers (values x fs_3238019266) at hchild

      exact node_3238019266 x (by omega) hchild
    ...
    · have hchild := hc
      ...
      change Covers (values x fs_2164281538) at hchild

      exact node_2164281538 x (by omega) hchild
    ...
    · have hchild := hc
      ...
      change Covers (values x fs_1090543810) at hchild

      exact node_1090543810 x (by omega) hchild
  ...
  · have hchoices : (x 2 = 0 ∧ x 6 = 5) ∨ (x 2 = 1 ∧ x 6 = 4) ∨ (x 2 = 2 ∧ x 6 = 3) ∨ (x 2 = 3 ∧ x 6 = 2) ∨ (x 2 = 4 ∧ x 6 = 1) ∨ (x 2 = 5 ∧ x 6 = 0) := by
    ...
    · have hchild := hc
      ...
      change Covers (values x fs_412333641922) at hchild

      exact node_412333641922 x (by omega) hchild
    ...
    · have hchild := hc
      ...
      change Covers (values x fs_343614169282) at hchild

      exact node_343614169282 x (by omega) hchild
    ...
    · have hchild := hc
      ...
      change Covers (values x fs_274894696642) at hchild

      exact node_274894696642 x (by omega) hchild
    ...
    · have hchild := hc
      ...
      change Covers (values x fs_206175224002) at hchild

      exact node_206175224002 x (by omega) hchild
    ...
    · have hchild := hc
      ...
      change Covers (values x fs_137455751362) at hchild

      exact node_137455751362 x (by omega) hchild
    ...
    · have hchild := hc
      ...
      change Covers (values x fs_68736278722) at hchild

      exact node_68736278722 x (by omega) hchild
  ...
  · have hchoices : (x 3 = 0 ∧ x 5 = 3) ∨ (x 3 = 1 ∧ x 5 = 2) ∨ (x 3 = 2 ∧ x 5 = 1) ∨ (x 3 = 3 ∧ x 5 = 0) := by
    ...
    · have hchild := hc
      ...
      change Covers (values x fs_4312006850) at hchild

      exact node_4312006850 x (by omega) hchild
    ...
    · have hchild := hc
      ...
      change Covers (values x fs_3238527170) at hchild

      exact node_3238527170 x (by omega) hchild
    ...
    · have hchild := hc
      ...
      change Covers (values x fs_2165047490) at hchild

      exact node_2165047490 x (by omega) hchild
    ...
    · have hchild := hc
      ...
      change Covers (values x fs_1091567810) at hchild

      exact node_1091567810 x (by omega) hchild
  ...
  · have hchoices : (x 3 = 0 ∧ x 6 = 4) ∨ (x 3 = 1 ∧ x 6 = 3) ∨ (x 3 = 2 ∧ x 6 = 2) ∨ (x 3 = 3 ∧ x 6 = 1) ∨ (x 3 = 4 ∧ x 6 = 0) := by
    ...
    · have hchild := hc
      ...
      change Covers (values x fs_343614423234) at hchild

      exact node_343614423234 x (by omega) hchild
    ...
    · have hchild := hc
      ...
      change Covers (values x fs_274895208642) at hchild

      exact node_274895208642 x (by omega) hchild
    ...
    · have hchild := hc
      ...
      change Covers (values x fs_206175994050) at hchild

      exact node_206175994050 x (by omega) hchild
    ...
    · have hchild := hc
      ...
      change Covers (values x fs_137456779458) at hchild

      exact node_137456779458 x (by omega) hchild
    ...
    · have hchild := hc
      ...
      change Covers (values x fs_68737564866) at hchild

      exact node_68737564866 x (by omega) hchild
  ...
  · have hchoices : (x 3 = 0 ∧ x 6 = 5) ∨ (x 3 = 1 ∧ x 6 = 4) ∨ (x 3 = 2 ∧ x 6 = 3) ∨ (x 3 = 3 ∧ x 6 = 2) ∨ (x 3 = 4 ∧ x 6 = 1) ∨ (x 3 = 5 ∧ x 6 = 0) := by
    ...
    · have hchild := hc
      ...
      change Covers (values x fs_412333899970) at hchild

      exact node_412333899970 x (by omega) hchild
    ...
    · have hchild := hc
      ...
      change Covers (values x fs_343614685378) at hchild

      exact node_343614685378 x (by omega) hchild
    ...
    · have hchild := hc
      ...
      change Covers (values x fs_274895470786) at hchild

      exact node_274895470786 x (by omega) hchild
    ...
    · have hchild := hc
      ...
      change Covers (values x fs_206176256194) at hchild

      exact node_206176256194 x (by omega) hchild
    ...
    · have hchild := hc
      ...
      change Covers (values x fs_137457041602) at hchild

      exact node_137457041602 x (by omega) hchild
    ...
    · have hchild := hc
      ...
      change Covers (values x fs_68737827010) at hchild

      exact node_68737827010 x (by omega) hchild
