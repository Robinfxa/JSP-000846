...
namespace JSP846EightLarge.C176P
open JSP846Standard
open JSP846Replay
def chords : Finset (Sym2 (Fin 8)) := {s(0,3),s(0,5),s(1,4),s(2,6),s(4,7)}
...
def replayForms : List JSP846Replay.Form :=
  JSP846Residual.HintCases.C176.forms.map JSP846HintBridge.exprToForm
...
theorem excluded : ¬ ModelFeasible (by decide : 0 < 8) chords := by
  ...
  have hb : JSP846Residual.Bounds JSP846Residual.HintCases.C176.lower xs := by
    simp [JSP846Residual.HintCases.C176.lower, xs, JSP846HintBridge.finList8,
  ...
  have hc' : JSP846Replay.Covers
      (JSP846Replay.values (JSP846HintBridge.listWeight xs)
        (JSP846Residual.HintCases.C176.forms.map JSP846HintBridge.exprToForm)) := by
    have hwEq := JSP846HintBridge.listWeight_finList8 w
    rw [hwEq]
    simpa [replayForms] using hc
  have ho : JSP846Residual.OriginalFeasible
      JSP846Residual.HintCases.C176.lower
      JSP846Residual.HintCases.C176.forms :=
    JSP846HintBridge.originalFeasible_of_replay
      JSP846Residual.HintCases.C176.lower
      JSP846Residual.HintCases.C176.forms xs hb hs hc'
  exact JSP846Residual.HintCases.C176.infeasible ho

end JSP846EightLarge.C176P
#print axioms JSP846EightLarge.C176P.table_exact
#print axioms JSP846EightLarge.C176P.excluded
