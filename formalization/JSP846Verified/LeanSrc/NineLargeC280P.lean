...
namespace JSP846NineLarge.C280P
open JSP846Standard
open JSP846Replay
open JSP846HintBridge
open JSP846Residual
def chords : Finset (Sym2 (Fin 9)) := {s(0,4),s(0,5),s(1,6),s(2,7),s(3,8)}
def z0 : Fin 2 × Finset (Sym2 (Fin 9)) := ((0:Fin 2), {s(0,4),s(0,5),s(1,6),s(2,7)})
def C0 : Finset (Fin 9) := {0,4,5}
...
def z1 : Fin 2 × Finset (Sym2 (Fin 9)) := ((0:Fin 2), {s(0,4),s(0,5),s(1,6),s(3,8)})
def C1 : Finset (Fin 9) := {0,4,5}
theorem z1_not_cycle : ¬ IsSymbolicCycle (by decide : 0 < 9)
  ...
  all_goals decide +kernel
def z2 : Fin 2 × Finset (Sym2 (Fin 9)) := ((0:Fin 2), {s(0,4),s(0,5),s(2,7),s(3,8)})
def C2 : Finset (Fin 9) := {0,4,5}
theorem z2_not_cycle : ¬ IsSymbolicCycle (by decide : 0 < 9)
  ...
  all_goals decide +kernel
def z3 : Fin 2 × Finset (Sym2 (Fin 9)) := ((0:Fin 2), {s(0,4),s(1,6),s(2,7),s(3,8)})
def C3 : Finset (Fin 9) := {0,3,4,8}
theorem z3_not_cycle : ¬ IsSymbolicCycle (by decide : 0 < 9)
    (reconstructArcs z3.2 z3.1.val) z3.2 := by
  apply symbolic_cut_contradiction (by decide : 0 < 9)
    (reconstructArcs z3.2 z3.1.val) z3.2 C3 (0:Fin 9) (1:Fin 9)
  all_goals decide +kernel
def z4 : Fin 2 × Finset (Sym2 (Fin 9)) := ((0:Fin 2), {s(0,5),s(1,6),s(2,7),s(3,8)})
def C4 : Finset (Fin 9) := {0,3,4,5,8}
theorem z4_not_cycle : ¬ IsSymbolicCycle (by decide : 0 < 9)
    (reconstructArcs z4.2 z4.1.val) z4.2 := by
  apply symbolic_cut_contradiction (by decide : 0 < 9)
    (reconstructArcs z4.2 z4.1.val) z4.2 C4 (0:Fin 9) (1:Fin 9)
  all_goals decide +kernel
def z5 : Fin 2 × Finset (Sym2 (Fin 9)) := ((1:Fin 2), {s(0,4),s(1,6),s(2,7),s(3,8)})
def C5 : Finset (Fin 9) := {0,1,4,5,6}
theorem z5_not_cycle : ¬ IsSymbolicCycle (by decide : 0 < 9)
  ...
  all_goals decide +kernel
def z6 : Fin 2 × Finset (Sym2 (Fin 9)) := ((1:Fin 2), {s(0,5),s(1,6),s(2,7),s(3,8)})
...
def replayForms : List JSP846Replay.Form :=
  JSP846Residual.HintCases.C280.forms.map JSP846HintBridge.exprToForm
...
theorem excluded : ¬ ModelFeasible (by decide : 0 < 9) chords := by
  ...
  have hb : JSP846Residual.Bounds JSP846Residual.HintCases.C280.lower xs := by
    simp [JSP846Residual.HintCases.C280.lower, xs, JSP846HintBridge.finList9,
  ...
  have hc' : JSP846Replay.Covers
      (JSP846Replay.values (JSP846HintBridge.listWeight xs)
        (JSP846Residual.HintCases.C280.forms.map JSP846HintBridge.exprToForm)) := by
    have hwEq := JSP846HintBridge.listWeight_finList9 w
    rw [hwEq]
    simpa [replayForms] using hc
  have ho : JSP846Residual.OriginalFeasible
      JSP846Residual.HintCases.C280.lower
      JSP846Residual.HintCases.C280.forms :=
    JSP846HintBridge.originalFeasible_of_replay
      JSP846Residual.HintCases.C280.lower
      JSP846Residual.HintCases.C280.forms xs hb hs hc'
  exact JSP846Residual.HintCases.C280.infeasible ho
end JSP846NineLarge.C280P
#print axioms JSP846NineLarge.C280P.pruned_subset
#print axioms JSP846NineLarge.C280P.excluded
