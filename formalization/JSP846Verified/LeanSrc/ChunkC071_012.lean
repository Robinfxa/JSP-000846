import ChunkC071_011
set_option autoImplicit false
set_option maxRecDepth 100000
set_option maxHeartbeats 8000000
namespace JSP846DAG.C071
open JSP846Replay
def fs_1073745987 : List Form := [(4,[]),(3,[]),(5,[3,4]),(7,[3,4]),(6,[3,4]),(8,[3,4]),(5,[]),(7,[]),(6,[]),(8,[]),(6,[3,4]),(5,[3,4]),(6,[3,6]),(5,[3,6]),(7,[4,6]),(9,[4,6]),(8,[4,6]),(10,[4,6]),(7,[3,6]),(9,[3,6]),(8,[3,6]),(10,[3,6]),(4,[4,6]),(5,[3,7]),(7,[3,7]),(6,[3,7]),(8,[3,7]),(4,[4,7]),(8,[3,7]),(7,[3,7]),(7,[4,7]),(9,[4,7]),(8,[4,7]),(10,[4,7]),(5,[6,7]),(7,[6,7]),(6,[6,7]),(8,[6,7]),(8,[3,4,6,7]),(7,[3,4,6,7]),(4,[6,7]),(7,[3,4,6,7]),(9,[3,4,6,7]),(8,[3,4,6,7]),(10,[3,4,6,7])]
...
theorem node_1073745987 (x : Nat → Nat) (hs : x 3 + (x 4 + (x 6 + (x 7 + (0)))) = 31)
  ...
  have hopts : (x 3 + (x 4 + (0)) = 0) ∨ (x 3 + (x 4 + (0)) = 1) ∨ (x 3 + (x 4 + (0)) = 2) ∨ (x 3 + (x 6 + (0)) = 1) ∨ (x 3 + (x 6 + (0)) = 2) ∨ (x 3 + (x 6 + (0)) = 3) ∨ (x 3 + (x 6 + (0)) = 4) ∨ (x 3 + (x 7 + (0)) = 1) ∨ (x 3 + (x 7 + (0)) = 2) ∨ (x 3 + (x 7 + (0)) = 3) ∨ (x 3 + (x 7 + (0)) = 4) ∨ (x 4 + (x 6 + (0)) = 0) ∨ (x 4 + (x 6 + (0)) = 1) ∨ (x 4 + (x 6 + (0)) = 2) ∨ (x 4 + (x 7 + (0)) = 0) ∨ (x 4 + (x 7 + (0)) = 1) ∨ (x 4 + (x 7 + (0)) = 2) ∨ (x 4 + (x 7 + (0)) = 3) ∨ (x 4 + (x 7 + (0)) = 4) ∨ (x 6 + (x 7 + (0)) = 0) ∨ (x 6 + (x 7 + (0)) = 1) ∨ (x 6 + (x 7 + (0)) = 2) := by
  ...
  · have hchoices : (x 3 = 0 ∧ x 6 = 4) ∨ (x 3 = 1 ∧ x 6 = 3) ∨ (x 3 = 2 ∧ x 6 = 2) ∨ (x 3 = 3 ∧ x 6 = 1) ∨ (x 3 = 4 ∧ x 6 = 0) := by
    ...
    · have hchild := hc
      ...
      change Covers (values x fs_344671391811) at hchild

      exact node_344671391811 x (by omega) hchild
    ...
    · have hchild := hc
      ...
      change Covers (values x fs_275952177219) at hchild

      exact node_275952177219 x (by omega) hchild
    ...
    · have hchild := hc
      ...
      change Covers (values x fs_207232962627) at hchild

      exact node_207232962627 x (by omega) hchild
    ...
    · have hchild := hc
      ...
      change Covers (values x fs_138513748035) at hchild

      exact node_138513748035 x (by omega) hchild
    ...
    · have hchild := hc
      ...
      change Covers (values x fs_69794533443) at hchild

      exact node_69794533443 x (by omega) hchild
  ...
  · have hchoices : (x 4 = 0 ∧ x 7 = 4) ∨ (x 4 = 1 ∧ x 7 = 3) ∨ (x 4 = 2 ∧ x 7 = 2) ∨ (x 4 = 3 ∧ x 7 = 1) ∨ (x 4 = 4 ∧ x 7 = 0) := by
    ...
    · have hchild := hc
      ...
      change Covers (values x fs_21991323078723) at hchild

      exact node_21991323078723 x (by omega) hchild
    ...
    · have hchild := hc
      ...
      change Covers (values x fs_17593293344835) at hchild

      exact node_17593293344835 x (by omega) hchild
    ...
    · have hchild := hc
      ...
      change Covers (values x fs_13195263610947) at hchild

      exact node_13195263610947 x (by omega) hchild
    ...
    · have hchild := hc
      ...
      change Covers (values x fs_8797233877059) at hchild

      exact node_8797233877059 x (by omega) hchild
    ...
    · have hchild := hc
      ...
      change Covers (values x fs_4399204143171) at hchild

      exact node_4399204143171 x (by omega) hchild
