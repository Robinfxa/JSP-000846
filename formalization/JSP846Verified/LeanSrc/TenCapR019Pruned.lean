...
namespace JSP846TenCap.R019
open JSP846Standard
def chords : Finset (Sym2 (Fin 10)) := {s(0,1),s(2,4),s(3,8),s(5,9),s(6,7)}
...
theorem z5_not_cycle : ¬ IsSymbolicCycle (by decide : 0 < 10)
  ...
  all_goals decide +kernel
def z6 : Fin 2 × Finset (Sym2 (Fin 10)) := ((1:Fin 2), {s(0,1),s(3,8),s(5,9)})
...
theorem z6_not_cycle : ¬ IsSymbolicCycle (by decide : 0 < 10)
  ...
  all_goals decide +kernel
def z7 : Fin 2 × Finset (Sym2 (Fin 10)) := ((1:Fin 2), {s(0,1),s(2,4),s(3,8),s(5,9)})
...
theorem z7_not_cycle : ¬ IsSymbolicCycle (by decide : 0 < 10)
  ...
  all_goals decide +kernel
def z8 : Fin 2 × Finset (Sym2 (Fin 10)) := ((1:Fin 2), {s(0,1),s(6,7)})
def C8 : Finset (Fin 10) := {0,1}
theorem z8_not_cycle : ¬ IsSymbolicCycle (by decide : 0 < 10)
    (reconstructArcs z8.2 z8.1.val) z8.2 := by
  apply symbolic_cut_contradiction (by decide : 0 < 10)
    (reconstructArcs z8.2 z8.1.val) z8.2 C8 (0:Fin 10) (6:Fin 10)
  all_goals decide +kernel
def z9 : Fin 2 × Finset (Sym2 (Fin 10)) := ((0:Fin 2), {s(2,4),s(6,7)})
def C9 : Finset (Fin 10) := {2,3,4}
theorem z9_not_cycle : ¬ IsSymbolicCycle (by decide : 0 < 10)
    (reconstructArcs z9.2 z9.1.val) z9.2 := by
  apply symbolic_cut_contradiction (by decide : 0 < 10)
    (reconstructArcs z9.2 z9.1.val) z9.2 C9 (2:Fin 10) (6:Fin 10)
  all_goals decide +kernel
def z10 : Fin 2 × Finset (Sym2 (Fin 10)) := ((1:Fin 2), {s(0,1),s(2,4),s(6,7)})
...
theorem z10_not_cycle : ¬ IsSymbolicCycle (by decide : 0 < 10)
  ...
  all_goals decide +kernel
def z11 : Fin 2 × Finset (Sym2 (Fin 10)) := ((1:Fin 2), {s(3,8),s(6,7)})
def C11 : Finset (Fin 10) := {0,1,2,3,8,9}
theorem z11_not_cycle : ¬ IsSymbolicCycle (by decide : 0 < 10)
  ...
  all_goals decide +kernel
def z12 : Fin 2 × Finset (Sym2 (Fin 10)) := ((0:Fin 2), {s(0,1),s(3,8),s(6,7)})
def C12 : Finset (Fin 10) := {0,1,2,3,8,9}
theorem z12_not_cycle : ¬ IsSymbolicCycle (by decide : 0 < 10)
  ...
  all_goals decide +kernel
def z13 : Fin 2 × Finset (Sym2 (Fin 10)) := ((1:Fin 2), {s(0,1),s(3,8),s(6,7)})
...
theorem z13_not_cycle : ¬ IsSymbolicCycle (by decide : 0 < 10)
  ...
  all_goals decide +kernel
def z14 : Fin 2 × Finset (Sym2 (Fin 10)) := ((1:Fin 2), {s(2,4),s(3,8),s(6,7)})
def C14 : Finset (Fin 10) := {0,1,2,3,4,8,9}
theorem z14_not_cycle : ¬ IsSymbolicCycle (by decide : 0 < 10)
  ...
  all_goals decide +kernel
def z15 : Fin 2 × Finset (Sym2 (Fin 10)) := ((0:Fin 2), {s(0,1),s(2,4),s(3,8),s(6,7)})
...
theorem z15_not_cycle : ¬ IsSymbolicCycle (by decide : 0 < 10)
  ...
  all_goals decide +kernel
def z16 : Fin 2 × Finset (Sym2 (Fin 10)) := ((1:Fin 2), {s(0,1),s(2,4),s(3,8),s(6,7)})
...
theorem z16_not_cycle : ¬ IsSymbolicCycle (by decide : 0 < 10)
  ...
  all_goals decide +kernel
def z17 : Fin 2 × Finset (Sym2 (Fin 10)) := ((1:Fin 2), {s(5,9),s(6,7)})
def C17 : Finset (Fin 10) := {0,1,2,3,4,5,9}
theorem z17_not_cycle : ¬ IsSymbolicCycle (by decide : 0 < 10)
  ...
  all_goals decide +kernel
def z18 : Fin 2 × Finset (Sym2 (Fin 10)) := ((0:Fin 2), {s(0,1),s(5,9),s(6,7)})
def C18 : Finset (Fin 10) := {0,1,2,3,4,5,9}
theorem z18_not_cycle : ¬ IsSymbolicCycle (by decide : 0 < 10)
  ...
  all_goals decide +kernel
def z19 : Fin 2 × Finset (Sym2 (Fin 10)) := ((1:Fin 2), {s(0,1),s(5,9),s(6,7)})
...
theorem z19_not_cycle : ¬ IsSymbolicCycle (by decide : 0 < 10)
  ...
  all_goals decide +kernel
def z20 : Fin 2 × Finset (Sym2 (Fin 10)) := ((0:Fin 2), {s(2,4),s(5,9),s(6,7)})
def C20 : Finset (Fin 10) := {2,3,4}
theorem z20_not_cycle : ¬ IsSymbolicCycle (by decide : 0 < 10)
    (reconstructArcs z20.2 z20.1.val) z20.2 := by
  apply symbolic_cut_contradiction (by decide : 0 < 10)
    (reconstructArcs z20.2 z20.1.val) z20.2 C20 (2:Fin 10) (5:Fin 10)
  all_goals decide +kernel
def z21 : Fin 2 × Finset (Sym2 (Fin 10)) := ((1:Fin 2), {s(2,4),s(5,9),s(6,7)})
def C21 : Finset (Fin 10) := {0,1,2,4,5,9}
theorem z21_not_cycle : ¬ IsSymbolicCycle (by decide : 0 < 10)
  ...
  all_goals decide +kernel
def z22 : Fin 2 × Finset (Sym2 (Fin 10)) := ((0:Fin 2), {s(0,1),s(2,4),s(5,9),s(6,7)})
def C22 : Finset (Fin 10) := {0,1,2,4,5,9}
theorem z22_not_cycle : ¬ IsSymbolicCycle (by decide : 0 < 10)
  ...
  all_goals decide +kernel
def z23 : Fin 2 × Finset (Sym2 (Fin 10)) := ((1:Fin 2), {s(0,1),s(2,4),s(5,9),s(6,7)})
...
theorem z23_not_cycle : ¬ IsSymbolicCycle (by decide : 0 < 10)
  ...
  all_goals decide +kernel
def z24 : Fin 2 × Finset (Sym2 (Fin 10)) := ((0:Fin 2), {s(3,8),s(5,9),s(6,7)})
def C24 : Finset (Fin 10) := {3,4,5,8,9}
theorem z24_not_cycle : ¬ IsSymbolicCycle (by decide : 0 < 10)
  ...
  all_goals decide +kernel
def z25 : Fin 2 × Finset (Sym2 (Fin 10)) := ((1:Fin 2), {s(0,1),s(3,8),s(5,9),s(6,7)})
...
theorem z25_not_cycle : ¬ IsSymbolicCycle (by decide : 0 < 10)
  ...
  all_goals decide +kernel
def z26 : Fin 2 × Finset (Sym2 (Fin 10)) := ((0:Fin 2), {s(2,4),s(3,8),s(5,9),s(6,7)})
def C26 : Finset (Fin 10) := {2,3,4,5,8,9}
theorem z26_not_cycle : ¬ IsSymbolicCycle (by decide : 0 < 10)
  ...
  all_goals decide +kernel
def z27 : Fin 2 × Finset (Sym2 (Fin 10)) := ((1:Fin 2), {s(0,1),s(2,4),s(3,8),s(5,9),s(6,7)})
...
theorem rep_eq : tenRepAt (19:Fin 79) = chords := by decide +kernel
theorem rep_excluded : ¬ ModelFeasible (by decide : 0 < 10) (tenRepAt (19:Fin 79)) := by
  rw [rep_eq]
  exact excluded
end JSP846TenCap.R019
#print axioms JSP846TenCap.R019.small
#print axioms JSP846TenCap.R019.rep_excluded
