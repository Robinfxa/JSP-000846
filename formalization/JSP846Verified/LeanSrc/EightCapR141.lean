...
namespace JSP846Eight.R141
open JSP846Standard
def chords : Finset (Sym2 (Fin 8)) := {s(0,1),s(0,4),s(0,5),s(2,7),s(3,6)}
...
theorem z4_not_cycle : ¬ IsSymbolicCycle (by decide : 0 < 8) (reconstructArcs z4.2 z4.1.val) z4.2 := by
  ...
  all_goals decide +kernel
def z5 : Fin 2 × Finset (Sym2 (Fin 8)) := ((0:Fin 2), {s(0,4),s(0,5),s(2,7),s(3,6)})
def C5 : Finset (Fin 8) := {0,4,5}
...
end JSP846Eight.R141
#print axioms JSP846Eight.R141.infeasible
