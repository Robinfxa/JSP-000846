...
namespace JSP846Eight.R075
open JSP846Standard
def chords : Finset (Sym2 (Fin 8)) := {s(0,1),s(0,3),s(0,4),s(2,6),s(5,7)}
...
theorem z5_not_cycle : ¬ IsSymbolicCycle (by decide : 0 < 8) (reconstructArcs z5.2 z5.1.val) z5.2 := by
  ...
  all_goals decide +kernel
def z6 : Fin 2 × Finset (Sym2 (Fin 8)) := ((0:Fin 2), {s(0,3),s(0,4),s(5,7)})
...
end JSP846Eight.R075
#print axioms JSP846Eight.R075.infeasible
