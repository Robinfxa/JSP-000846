...
namespace JSP846TenCap.R012
open JSP846Standard
def chords : Finset (Sym2 (Fin 10)) := {s(0,1),s(2,4),s(3,5),s(6,9),s(7,8)}
...
theorem z2_not_cycle : ¬ IsSymbolicCycle (by decide : 0 < 10)
  ...
  all_goals decide +kernel
def z3 : Fin 2 × Finset (Sym2 (Fin 10)) := ((1:Fin 2), {s(0,1),s(6,9)})
def C3 : Finset (Fin 10) := {0,1}
theorem z3_not_cycle : ¬ IsSymbolicCycle (by decide : 0 < 10)
    (reconstructArcs z3.2 z3.1.val) z3.2 := by
  apply symbolic_cut_contradiction (by decide : 0 < 10)
    (reconstructArcs z3.2 z3.1.val) z3.2 C3 (0:Fin 10) (6:Fin 10)
  all_goals decide +kernel
def z4 : Fin 2 × Finset (Sym2 (Fin 10)) := ((0:Fin 2), {s(2,4),s(6,9)})
def C4 : Finset (Fin 10) := {2,3,4}
theorem z4_not_cycle : ¬ IsSymbolicCycle (by decide : 0 < 10)
    (reconstructArcs z4.2 z4.1.val) z4.2 := by
  apply symbolic_cut_contradiction (by decide : 0 < 10)
    (reconstructArcs z4.2 z4.1.val) z4.2 C4 (2:Fin 10) (6:Fin 10)
  all_goals decide +kernel
def z5 : Fin 2 × Finset (Sym2 (Fin 10)) := ((1:Fin 2), {s(0,1),s(2,4),s(6,9)})
...
theorem z5_not_cycle : ¬ IsSymbolicCycle (by decide : 0 < 10)
  ...
  all_goals decide +kernel
def z6 : Fin 2 × Finset (Sym2 (Fin 10)) := ((0:Fin 2), {s(3,5),s(6,9)})
def C6 : Finset (Fin 10) := {3,4,5}
theorem z6_not_cycle : ¬ IsSymbolicCycle (by decide : 0 < 10)
    (reconstructArcs z6.2 z6.1.val) z6.2 := by
  apply symbolic_cut_contradiction (by decide : 0 < 10)
    (reconstructArcs z6.2 z6.1.val) z6.2 C6 (3:Fin 10) (6:Fin 10)
  all_goals decide +kernel
def z7 : Fin 2 × Finset (Sym2 (Fin 10)) := ((1:Fin 2), {s(0,1),s(3,5),s(6,9)})
def C7 : Finset (Fin 10) := {0,1}
theorem z7_not_cycle : ¬ IsSymbolicCycle (by decide : 0 < 10)
    (reconstructArcs z7.2 z7.1.val) z7.2 := by
  apply symbolic_cut_contradiction (by decide : 0 < 10)
    (reconstructArcs z7.2 z7.1.val) z7.2 C7 (0:Fin 10) (3:Fin 10)
  all_goals decide +kernel
def z8 : Fin 2 × Finset (Sym2 (Fin 10)) := ((0:Fin 2), {s(2,4),s(3,5),s(6,9)})
def C8 : Finset (Fin 10) := {2,3,4,5}
theorem z8_not_cycle : ¬ IsSymbolicCycle (by decide : 0 < 10)
    (reconstructArcs z8.2 z8.1.val) z8.2 := by
  apply symbolic_cut_contradiction (by decide : 0 < 10)
    (reconstructArcs z8.2 z8.1.val) z8.2 C8 (2:Fin 10) (6:Fin 10)
  all_goals decide +kernel
def z9 : Fin 2 × Finset (Sym2 (Fin 10)) := ((1:Fin 2), {s(0,1),s(2,4),s(3,5),s(6,9)})
def C9 : Finset (Fin 10) := {0,1}
theorem z9_not_cycle : ¬ IsSymbolicCycle (by decide : 0 < 10)
    (reconstructArcs z9.2 z9.1.val) z9.2 := by
  apply symbolic_cut_contradiction (by decide : 0 < 10)
    (reconstructArcs z9.2 z9.1.val) z9.2 C9 (0:Fin 10) (2:Fin 10)
  all_goals decide +kernel
def z10 : Fin 2 × Finset (Sym2 (Fin 10)) := ((1:Fin 2), {s(0,1),s(7,8)})
def C10 : Finset (Fin 10) := {0,1}
theorem z10_not_cycle : ¬ IsSymbolicCycle (by decide : 0 < 10)
    (reconstructArcs z10.2 z10.1.val) z10.2 := by
  apply symbolic_cut_contradiction (by decide : 0 < 10)
    (reconstructArcs z10.2 z10.1.val) z10.2 C10 (0:Fin 10) (7:Fin 10)
  all_goals decide +kernel
def z11 : Fin 2 × Finset (Sym2 (Fin 10)) := ((0:Fin 2), {s(2,4),s(7,8)})
def C11 : Finset (Fin 10) := {2,3,4}
theorem z11_not_cycle : ¬ IsSymbolicCycle (by decide : 0 < 10)
    (reconstructArcs z11.2 z11.1.val) z11.2 := by
  apply symbolic_cut_contradiction (by decide : 0 < 10)
    (reconstructArcs z11.2 z11.1.val) z11.2 C11 (2:Fin 10) (7:Fin 10)
  all_goals decide +kernel
def z12 : Fin 2 × Finset (Sym2 (Fin 10)) := ((1:Fin 2), {s(0,1),s(2,4),s(7,8)})
...
theorem z12_not_cycle : ¬ IsSymbolicCycle (by decide : 0 < 10)
  ...
  all_goals decide +kernel
def z13 : Fin 2 × Finset (Sym2 (Fin 10)) := ((0:Fin 2), {s(3,5),s(7,8)})
def C13 : Finset (Fin 10) := {3,4,5}
theorem z13_not_cycle : ¬ IsSymbolicCycle (by decide : 0 < 10)
    (reconstructArcs z13.2 z13.1.val) z13.2 := by
  apply symbolic_cut_contradiction (by decide : 0 < 10)
    (reconstructArcs z13.2 z13.1.val) z13.2 C13 (3:Fin 10) (7:Fin 10)
  all_goals decide +kernel
def z14 : Fin 2 × Finset (Sym2 (Fin 10)) := ((1:Fin 2), {s(0,1),s(3,5),s(7,8)})
...
theorem z14_not_cycle : ¬ IsSymbolicCycle (by decide : 0 < 10)
  ...
  all_goals decide +kernel
def z15 : Fin 2 × Finset (Sym2 (Fin 10)) := ((0:Fin 2), {s(2,4),s(3,5),s(7,8)})
...
theorem z15_not_cycle : ¬ IsSymbolicCycle (by decide : 0 < 10)
  ...
  all_goals decide +kernel
def z16 : Fin 2 × Finset (Sym2 (Fin 10)) := ((1:Fin 2), {s(0,1),s(2,4),s(3,5),s(7,8)})
...
theorem z16_not_cycle : ¬ IsSymbolicCycle (by decide : 0 < 10)
  ...
  all_goals decide +kernel
def z17 : Fin 2 × Finset (Sym2 (Fin 10)) := ((1:Fin 2), {s(6,9),s(7,8)})
def C17 : Finset (Fin 10) := {0,1,2,3,4,5,6,9}
theorem z17_not_cycle : ¬ IsSymbolicCycle (by decide : 0 < 10)
    (reconstructArcs z17.2 z17.1.val) z17.2 := by
  apply symbolic_cut_contradiction (by decide : 0 < 10)
    (reconstructArcs z17.2 z17.1.val) z17.2 C17 (0:Fin 10) (7:Fin 10)
  all_goals decide +kernel
def z18 : Fin 2 × Finset (Sym2 (Fin 10)) := ((0:Fin 2), {s(0,1),s(6,9),s(7,8)})
...
theorem z18_not_cycle : ¬ IsSymbolicCycle (by decide : 0 < 10)
  ...
  all_goals decide +kernel
def z19 : Fin 2 × Finset (Sym2 (Fin 10)) := ((1:Fin 2), {s(0,1),s(6,9),s(7,8)})
...
theorem z19_not_cycle : ¬ IsSymbolicCycle (by decide : 0 < 10)
  ...
  all_goals decide +kernel
def z20 : Fin 2 × Finset (Sym2 (Fin 10)) := ((0:Fin 2), {s(2,4),s(6,9),s(7,8)})
def C20 : Finset (Fin 10) := {2,3,4}
theorem z20_not_cycle : ¬ IsSymbolicCycle (by decide : 0 < 10)
    (reconstructArcs z20.2 z20.1.val) z20.2 := by
  apply symbolic_cut_contradiction (by decide : 0 < 10)
    (reconstructArcs z20.2 z20.1.val) z20.2 C20 (2:Fin 10) (6:Fin 10)
  all_goals decide +kernel
def z21 : Fin 2 × Finset (Sym2 (Fin 10)) := ((1:Fin 2), {s(2,4),s(6,9),s(7,8)})
def C21 : Finset (Fin 10) := {0,1,2,4,5,6,9}
theorem z21_not_cycle : ¬ IsSymbolicCycle (by decide : 0 < 10)
  ...
  all_goals decide +kernel
def z22 : Fin 2 × Finset (Sym2 (Fin 10)) := ((0:Fin 2), {s(0,1),s(2,4),s(6,9),s(7,8)})
def C22 : Finset (Fin 10) := {0,1,2,4,5,6,9}
theorem z22_not_cycle : ¬ IsSymbolicCycle (by decide : 0 < 10)
  ...
  all_goals decide +kernel
def z23 : Fin 2 × Finset (Sym2 (Fin 10)) := ((1:Fin 2), {s(0,1),s(2,4),s(6,9),s(7,8)})
...
theorem z23_not_cycle : ¬ IsSymbolicCycle (by decide : 0 < 10)
  ...
  all_goals decide +kernel
def z24 : Fin 2 × Finset (Sym2 (Fin 10)) := ((0:Fin 2), {s(3,5),s(6,9),s(7,8)})
def C24 : Finset (Fin 10) := {3,4,5}
theorem z24_not_cycle : ¬ IsSymbolicCycle (by decide : 0 < 10)
    (reconstructArcs z24.2 z24.1.val) z24.2 := by
  apply symbolic_cut_contradiction (by decide : 0 < 10)
    (reconstructArcs z24.2 z24.1.val) z24.2 C24 (3:Fin 10) (6:Fin 10)
  all_goals decide +kernel
def z25 : Fin 2 × Finset (Sym2 (Fin 10)) := ((1:Fin 2), {s(3,5),s(6,9),s(7,8)})
def C25 : Finset (Fin 10) := {0,1,2,3,5,6,9}
theorem z25_not_cycle : ¬ IsSymbolicCycle (by decide : 0 < 10)
  ...
  all_goals decide +kernel
def z26 : Fin 2 × Finset (Sym2 (Fin 10)) := ((0:Fin 2), {s(0,1),s(3,5),s(6,9),s(7,8)})
def C26 : Finset (Fin 10) := {0,1,2,3,5,6,9}
theorem z26_not_cycle : ¬ IsSymbolicCycle (by decide : 0 < 10)
  ...
  all_goals decide +kernel
def z27 : Fin 2 × Finset (Sym2 (Fin 10)) := ((1:Fin 2), {s(0,1),s(3,5),s(6,9),s(7,8)})
def C27 : Finset (Fin 10) := {0,1}
theorem z27_not_cycle : ¬ IsSymbolicCycle (by decide : 0 < 10)
    (reconstructArcs z27.2 z27.1.val) z27.2 := by
  apply symbolic_cut_contradiction (by decide : 0 < 10)
    (reconstructArcs z27.2 z27.1.val) z27.2 C27 (0:Fin 10) (3:Fin 10)
  all_goals decide +kernel
def z28 : Fin 2 × Finset (Sym2 (Fin 10)) := ((0:Fin 2), {s(2,4),s(3,5),s(6,9),s(7,8)})
def C28 : Finset (Fin 10) := {2,3,4,5}
theorem z28_not_cycle : ¬ IsSymbolicCycle (by decide : 0 < 10)
    (reconstructArcs z28.2 z28.1.val) z28.2 := by
  apply symbolic_cut_contradiction (by decide : 0 < 10)
    (reconstructArcs z28.2 z28.1.val) z28.2 C28 (2:Fin 10) (6:Fin 10)
  all_goals decide +kernel
def z29 : Fin 2 × Finset (Sym2 (Fin 10)) := ((1:Fin 2), {s(2,4),s(3,5),s(6,9),s(7,8)})
def C29 : Finset (Fin 10) := {0,1,2,3,4,5,6,9}
theorem z29_not_cycle : ¬ IsSymbolicCycle (by decide : 0 < 10)
  ...
  all_goals decide +kernel
def z30 : Fin 2 × Finset (Sym2 (Fin 10)) := ((0:Fin 2), {s(0,1),s(2,4),s(3,5),s(6,9),s(7,8)})
...
theorem z30_not_cycle : ¬ IsSymbolicCycle (by decide : 0 < 10)
  ...
  all_goals decide +kernel
def z31 : Fin 2 × Finset (Sym2 (Fin 10)) := ((1:Fin 2), {s(0,1),s(2,4),s(3,5),s(6,9),s(7,8)})
...
theorem rep_eq : tenRepAt (12:Fin 79) = chords := by decide +kernel
theorem rep_excluded : ¬ ModelFeasible (by decide : 0 < 10) (tenRepAt (12:Fin 79)) := by
  rw [rep_eq]
  exact excluded
end JSP846TenCap.R012
#print axioms JSP846TenCap.R012.small
#print axioms JSP846TenCap.R012.rep_excluded
