...
namespace JSP846Eight.R330
open JSP846Standard
def chords : Finset (Sym2 (Fin 8)) := {s(0,2),s(0,3),s(0,6),s(1,4),s(5,7)}
...
theorem z7_not_cycle : ¬ IsSymbolicCycle (by decide : 0 < 8) (reconstructArcs z7.2 z7.1.val) z7.2 := by
  ...
  all_goals decide +kernel
def z8 : Fin 2 × Finset (Sym2 (Fin 8)) := ((0:Fin 2), {s(0,6),s(1,4),s(5,7)})
...
end JSP846Eight.R330
#print axioms JSP846Eight.R330.infeasible
