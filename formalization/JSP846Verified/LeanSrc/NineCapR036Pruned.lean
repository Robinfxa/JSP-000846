...
namespace JSP846Nine.R036P
open JSP846Standard
def chords : Finset (Sym2 (Fin 9)) := {s(0,1),s(0,4),s(2,6),s(3,5),s(7,8)}
...
theorem z1_not_cycle : ¬ IsSymbolicCycle (by decide : 0 < 9) (reconstructArcs z1.2 z1.1.val) z1.2 := by
  ...
  all_goals decide +kernel
def z2 : Fin 2 × Finset (Sym2 (Fin 9)) := ((1:Fin 2), {s(2,6),s(3,5)})
def C2 : Finset (Fin 9) := {0,1,2,6,7,8}
theorem z2_not_cycle : ¬ IsSymbolicCycle (by decide : 0 < 9) (reconstructArcs z2.2 z2.1.val) z2.2 := by
  ...
  all_goals decide +kernel
def z3 : Fin 2 × Finset (Sym2 (Fin 9)) := ((0:Fin 2), {s(0,1),s(2,6),s(3,5)})
...
theorem z3_not_cycle : ¬ IsSymbolicCycle (by decide : 0 < 9) (reconstructArcs z3.2 z3.1.val) z3.2 := by
  ...
  all_goals decide +kernel
def z4 : Fin 2 × Finset (Sym2 (Fin 9)) := ((1:Fin 2), {s(0,1),s(2,6),s(3,5)})
...
theorem z4_not_cycle : ¬ IsSymbolicCycle (by decide : 0 < 9) (reconstructArcs z4.2 z4.1.val) z4.2 := by
  ...
  all_goals decide +kernel
def z5 : Fin 2 × Finset (Sym2 (Fin 9)) := ((1:Fin 2), {s(0,1),s(7,8)})
def C5 : Finset (Fin 9) := {0,1}
theorem z5_not_cycle : ¬ IsSymbolicCycle (by decide : 0 < 9) (reconstructArcs z5.2 z5.1.val) z5.2 := by
  apply symbolic_cut_contradiction (by decide : 0 < 9) (reconstructArcs z5.2 z5.1.val) z5.2 C5 (0:Fin 9) (7:Fin 9)
  all_goals decide +kernel
def z6 : Fin 2 × Finset (Sym2 (Fin 9)) := ((1:Fin 2), {s(0,4),s(7,8)})
...
theorem z6_not_cycle : ¬ IsSymbolicCycle (by decide : 0 < 9) (reconstructArcs z6.2 z6.1.val) z6.2 := by
  ...
  all_goals decide +kernel
def z7 : Fin 2 × Finset (Sym2 (Fin 9)) := ((0:Fin 2), {s(0,1),s(0,4),s(7,8)})
...
theorem z7_not_cycle : ¬ IsSymbolicCycle (by decide : 0 < 9) (reconstructArcs z7.2 z7.1.val) z7.2 := by
  ...
  all_goals decide +kernel
def z8 : Fin 2 × Finset (Sym2 (Fin 9)) := ((0:Fin 2), {s(2,6),s(7,8)})
def C8 : Finset (Fin 9) := {2,3,4,5,6}
theorem z8_not_cycle : ¬ IsSymbolicCycle (by decide : 0 < 9) (reconstructArcs z8.2 z8.1.val) z8.2 := by
  apply symbolic_cut_contradiction (by decide : 0 < 9) (reconstructArcs z8.2 z8.1.val) z8.2 C8 (2:Fin 9) (7:Fin 9)
  all_goals decide +kernel
def z9 : Fin 2 × Finset (Sym2 (Fin 9)) := ((1:Fin 2), {s(0,1),s(2,6),s(7,8)})
...
theorem z9_not_cycle : ¬ IsSymbolicCycle (by decide : 0 < 9) (reconstructArcs z9.2 z9.1.val) z9.2 := by
  ...
  all_goals decide +kernel
def z10 : Fin 2 × Finset (Sym2 (Fin 9)) := ((1:Fin 2), {s(0,4),s(2,6),s(7,8)})
def C10 : Finset (Fin 9) := {0,1,2,4,5,6}
theorem z10_not_cycle : ¬ IsSymbolicCycle (by decide : 0 < 9) (reconstructArcs z10.2 z10.1.val) z10.2 := by
  ...
  all_goals decide +kernel
def z11 : Fin 2 × Finset (Sym2 (Fin 9)) := ((0:Fin 2), {s(0,1),s(0,4),s(2,6),s(7,8)})
def C11 : Finset (Fin 9) := {0,1,2,4,5,6}
theorem z11_not_cycle : ¬ IsSymbolicCycle (by decide : 0 < 9) (reconstructArcs z11.2 z11.1.val) z11.2 := by
  ...
  all_goals decide +kernel
def z12 : Fin 2 × Finset (Sym2 (Fin 9)) := ((0:Fin 2), {s(3,5),s(7,8)})
def C12 : Finset (Fin 9) := {3,4,5}
theorem z12_not_cycle : ¬ IsSymbolicCycle (by decide : 0 < 9) (reconstructArcs z12.2 z12.1.val) z12.2 := by
  apply symbolic_cut_contradiction (by decide : 0 < 9) (reconstructArcs z12.2 z12.1.val) z12.2 C12 (3:Fin 9) (7:Fin 9)
  all_goals decide +kernel
def z13 : Fin 2 × Finset (Sym2 (Fin 9)) := ((1:Fin 2), {s(0,1),s(3,5),s(7,8)})
...
theorem z13_not_cycle : ¬ IsSymbolicCycle (by decide : 0 < 9) (reconstructArcs z13.2 z13.1.val) z13.2 := by
  ...
  all_goals decide +kernel
def z14 : Fin 2 × Finset (Sym2 (Fin 9)) := ((1:Fin 2), {s(0,4),s(3,5),s(7,8)})
def C14 : Finset (Fin 9) := {0,1,2,3,4,5}
theorem z14_not_cycle : ¬ IsSymbolicCycle (by decide : 0 < 9) (reconstructArcs z14.2 z14.1.val) z14.2 := by
  ...
  all_goals decide +kernel
def z15 : Fin 2 × Finset (Sym2 (Fin 9)) := ((0:Fin 2), {s(0,1),s(0,4),s(3,5),s(7,8)})
def C15 : Finset (Fin 9) := {0,1,2,3,4,5}
theorem z15_not_cycle : ¬ IsSymbolicCycle (by decide : 0 < 9) (reconstructArcs z15.2 z15.1.val) z15.2 := by
  apply symbolic_cut_contradiction (by decide : 0 < 9) (reconstructArcs z15.2 z15.1.val) z15.2 C15 (0:Fin 9) (7:Fin 9)
  all_goals decide +kernel
def z16 : Fin 2 × Finset (Sym2 (Fin 9)) := ((0:Fin 2), {s(2,6),s(3,5),s(7,8)})
def C16 : Finset (Fin 9) := {2,3,5,6}
theorem z16_not_cycle : ¬ IsSymbolicCycle (by decide : 0 < 9) (reconstructArcs z16.2 z16.1.val) z16.2 := by
  apply symbolic_cut_contradiction (by decide : 0 < 9) (reconstructArcs z16.2 z16.1.val) z16.2 C16 (2:Fin 9) (7:Fin 9)
  all_goals decide +kernel
def z17 : Fin 2 × Finset (Sym2 (Fin 9)) := ((1:Fin 2), {s(2,6),s(3,5),s(7,8)})
...
theorem z17_not_cycle : ¬ IsSymbolicCycle (by decide : 0 < 9) (reconstructArcs z17.2 z17.1.val) z17.2 := by
  ...
  all_goals decide +kernel
def z18 : Fin 2 × Finset (Sym2 (Fin 9)) := ((0:Fin 2), {s(0,1),s(2,6),s(3,5),s(7,8)})
def C18 : Finset (Fin 9) := {0,1,2,6,7,8}
theorem z18_not_cycle : ¬ IsSymbolicCycle (by decide : 0 < 9) (reconstructArcs z18.2 z18.1.val) z18.2 := by
  ...
  all_goals decide +kernel
def z19 : Fin 2 × Finset (Sym2 (Fin 9)) := ((1:Fin 2), {s(0,1),s(2,6),s(3,5),s(7,8)})
...
theorem z19_not_cycle : ¬ IsSymbolicCycle (by decide : 0 < 9) (reconstructArcs z19.2 z19.1.val) z19.2 := by
  ...
  all_goals decide +kernel
def z20 : Fin 2 × Finset (Sym2 (Fin 9)) := ((1:Fin 2), {s(0,4),s(2,6),s(3,5),s(7,8)})
def C20 : Finset (Fin 9) := {0,1,2,3,4,5,6}
theorem z20_not_cycle : ¬ IsSymbolicCycle (by decide : 0 < 9) (reconstructArcs z20.2 z20.1.val) z20.2 := by
  apply symbolic_cut_contradiction (by decide : 0 < 9) (reconstructArcs z20.2 z20.1.val) z20.2 C20 (0:Fin 9) (7:Fin 9)
  all_goals decide +kernel
def z21 : Fin 2 × Finset (Sym2 (Fin 9)) := ((0:Fin 2), {s(0,1),s(0,4),s(2,6),s(3,5),s(7,8)})
...
end JSP846Nine.R036P
#print axioms JSP846Nine.R036P.infeasible
