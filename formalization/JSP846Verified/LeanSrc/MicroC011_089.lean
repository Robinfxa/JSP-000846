import MicroC011_088
set_option autoImplicit false
set_option maxRecDepth 100000
set_option maxHeartbeats 8000000
namespace JSP846DAG.C011
open JSP846Replay
def fs_266371 : List Form := [(4,[]),(3,[]),(5,[]),(7,[]),(6,[]),(8,[]),(5,[4]),(7,[4]),(6,[4]),(8,[4]),(4,[4]),(4,[5]),(7,[5]),(9,[5]),(8,[5]),(10,[5]),(7,[4,5]),(9,[4,5]),(8,[4,5]),(10,[4,5]),(4,[4,5]),(5,[6]),(7,[6]),(6,[6]),(8,[6]),(4,[6]),(6,[4,6]),(7,[4,6]),(9,[4,6]),(8,[4,6]),(10,[4,6]),(5,[5,6]),(7,[5,6]),(6,[5,6]),(8,[5,6]),(6,[5,6]),(4,[4,5,6]),(7,[4,5,6]),(9,[4,5,6]),(8,[4,5,6]),(10,[4,5,6])]
...
theorem node_266371 (x : Nat → Nat) (hs : x 4 + (x 5 + (x 6 + (0))) = 31)
  ...
  have hopts : (x 4 + (0) = 14) ∨ (x 4 + (0) = 15) ∨ (x 4 + (0) = 16) ∨ (x 4 + (0) = 17) ∨ (x 4 + (0) = 18) ∨ (x 5 + (0) = 12) ∨ (x 5 + (0) = 13) ∨ (x 5 + (0) = 14) ∨ (x 5 + (0) = 15) ∨ (x 5 + (0) = 16) ∨ (x 5 + (0) = 17) ∨ (x 5 + (0) = 18) ∨ (x 5 + (0) = 19) ∨ (x 6 + (0) = 13) ∨ (x 6 + (0) = 14) ∨ (x 6 + (0) = 15) ∨ (x 6 + (0) = 16) ∨ (x 6 + (0) = 17) ∨ (x 6 + (0) = 18) ∨ (x 6 + (0) = 19) := by
    ...
    simp only [values, fs_266371, val, List.map_cons, List.map_nil, List.sum_cons, List.sum_nil, List.mem_cons, List.not_mem_nil, or_false] at hm
  ...
  · have hchoices : (x 4 = 14) := by
    ...
    change Covers (values x fs_251924611) at hchild

    exact node_251924611 x (by omega) hchild
  ...
  · have hchoices : (x 4 = 15) := by
    ...
    change Covers (values x fs_268701827) at hchild

    exact node_268701827 x (by omega) hchild
  ...
  · have hchoices : (x 4 = 16) := by
    ...
    change Covers (values x fs_285479043) at hchild

    exact node_285479043 x (by omega) hchild
  ...
  · have hchoices : (x 4 = 17) := by
    ...
    change Covers (values x fs_302256259) at hchild

    exact node_302256259 x (by omega) hchild
  ...
  · have hchoices : (x 4 = 18) := by
    ...
    change Covers (values x fs_319033475) at hchild

    exact node_319033475 x (by omega) hchild
  ...
  · have hchoices : (x 5 = 12) := by
    ...
    change Covers (values x fs_13958910083) at hchild

    exact node_13958910083 x (by omega) hchild
  ...
  · have hchoices : (x 5 = 13) := by
    ...
    change Covers (values x fs_15032651907) at hchild

    exact node_15032651907 x (by omega) hchild
  ...
  · have hchoices : (x 5 = 14) := by
    ...
    change Covers (values x fs_16106393731) at hchild

    exact node_16106393731 x (by omega) hchild
  ...
  · have hchoices : (x 5 = 15) := by
    ...
    change Covers (values x fs_17180135555) at hchild

    exact node_17180135555 x (by omega) hchild
  ...
  · have hchoices : (x 5 = 16) := by
    ...
    change Covers (values x fs_18253877379) at hchild

    exact node_18253877379 x (by omega) hchild
  ...
  · have hchoices : (x 5 = 17) := by
    ...
    change Covers (values x fs_19327619203) at hchild

    exact node_19327619203 x (by omega) hchild
  ...
  · have hchoices : (x 5 = 18) := by
    ...
    change Covers (values x fs_20401361027) at hchild

    exact node_20401361027 x (by omega) hchild
  ...
  · have hchoices : (x 5 = 19) := by
    ...
    change Covers (values x fs_21475102851) at hchild

    exact node_21475102851 x (by omega) hchild
  ...
  · have hchoices : (x 6 = 13) := by
    ...
    change Covers (values x fs_962072940675) at hchild

    exact node_962072940675 x (by omega) hchild
  ...
  · have hchoices : (x 6 = 14) := by
    ...
    change Covers (values x fs_1030792417411) at hchild

    exact node_1030792417411 x (by omega) hchild
  ...
  · have hchoices : (x 6 = 15) := by
    ...
    change Covers (values x fs_1099511894147) at hchild

    exact node_1099511894147 x (by omega) hchild
  ...
  · have hchoices : (x 6 = 16) := by
    ...
    change Covers (values x fs_1168231370883) at hchild

    exact node_1168231370883 x (by omega) hchild
  ...
  · have hchoices : (x 6 = 17) := by
    ...
    change Covers (values x fs_1236950847619) at hchild

    exact node_1236950847619 x (by omega) hchild
  ...
  · have hchoices : (x 6 = 18) := by
    ...
    change Covers (values x fs_1305670324355) at hchild

    exact node_1305670324355 x (by omega) hchild
  ...
  · have hchoices : (x 6 = 19) := by
    ...
    change Covers (values x fs_1374389801091) at hchild

    exact node_1374389801091 x (by omega) hchild
