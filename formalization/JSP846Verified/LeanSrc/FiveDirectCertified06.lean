...
theorem bounded : ∀ D ∈ catalog, D = fiveRing ∨ (directInputs D).card < 39 := by
  ...
  · exact c19
  · exact c20
end JSP846FiveDirectCertified.B06
#print axioms JSP846FiveDirectCertified.B06.bounded
run_cmd do
  for ax in (← Lean.collectAxioms `JSP846FiveDirectCertified.B06.bounded) do
