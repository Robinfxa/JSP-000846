import ChunkC150_010
set_option autoImplicit false
set_option maxRecDepth 100000
set_option maxHeartbeats 8000000
namespace JSP846DAG.C150
open JSP846Replay
def fs_4398046515265 : List Form := [(3,[]),(3,[3]),(4,[4]),(5,[4]),(5,[3,4]),(6,[3,4]),(4,[5]),(5,[5]),(6,[4,5]),(5,[4,5]),(7,[3,4,5]),(6,[3,4,5]),(6,[6]),(5,[6]),(7,[3,6]),(6,[3,6]),(8,[4,6]),(7,[3,4,6]),(8,[3,4,6]),(6,[5,6]),(7,[5,6]),(7,[3,5,6]),(8,[3,5,6]),(6,[4,5,6]),(5,[3,4,5,6]),(4,[]),(5,[]),(5,[3]),(6,[3]),(6,[4]),(5,[3,4]),(7,[5]),(8,[3,5]),(8,[4,5]),(7,[3,4,5]),(8,[3,4,5]),(4,[6]),(5,[6]),(7,[4,6]),(8,[3,4,6]),(4,[5,6]),(6,[4,5,6]),(7,[4,5,6]),(7,[3,4,5,6]),(8,[3,4,5,6])]
...
theorem node_4398046515265 (x : Nat → Nat) (hs : x 3 + (x 4 + (x 5 + (x 6 + (0)))) = 33)
  ...
  have hopts : (x 3 + (0) = 0) ∨ (x 3 + (0) = 1) ∨ (x 3 + (0) = 3) ∨ (x 3 + (x 4 + (0)) = 0) ∨ (x 3 + (x 4 + (0)) = 1) ∨ (x 3 + (x 4 + (x 5 + (0))) = 0) ∨ (x 3 + (x 6 + (0)) = 0) ∨ (x 4 + (0) = 0) ∨ (x 4 + (0) = 1) ∨ (x 4 + (0) = 2) ∨ (x 4 + (x 5 + (0)) = 0) ∨ (x 4 + (x 5 + (0)) = 1) ∨ (x 4 + (x 5 + (x 6 + (0))) = 0) ∨ (x 5 + (0) = 1) ∨ (x 5 + (0) = 2) ∨ (x 5 + (x 6 + (0)) = 0) ∨ (x 5 + (x 6 + (0)) = 2) ∨ (x 6 + (0) = 0) ∨ (x 6 + (0) = 1) ∨ (x 6 + (0) = 2) := by
