...
namespace JSP846Seven.R284
open JSP846Standard
def chords : Finset (Sym2 (Fin 7)) := {s(0,1),s(2,4),s(2,5),s(3,6),s(4,6)}
...
theorem z9_not_cycle : ¬ IsSymbolicCycle (by decide : 0 < 7) (reconstructArcs z9.2 z9.1.val) z9.2 := by
  ...
  all_goals decide +kernel
def z10 : Fin 2 × Finset (Sym2 (Fin 7)) := ((1:Fin 2), {s(0,1),s(3,6),s(4,6)})
...
theorem z10_not_cycle : ¬ IsSymbolicCycle (by decide : 0 < 7) (reconstructArcs z10.2 z10.1.val) z10.2 := by
  ...
  all_goals decide +kernel
def z11 : Fin 2 × Finset (Sym2 (Fin 7)) := ((1:Fin 2), {s(0,1),s(2,4),s(3,6),s(4,6)})
...
end JSP846Seven.R284
#print axioms JSP846Seven.R284.infeasible
namespace JSP846Seven.R285
open JSP846Standard
def chords : Finset (Sym2 (Fin 7)) := {s(0,1),s(2,4),s(2,6),s(3,5),s(3,6)}
def z0 : Fin 2 × Finset (Sym2 (Fin 7)) := ((1:Fin 2), {s(0,1),s(2,4)})
def C0 : Finset (Fin 7) := {0,1}
theorem z0_not_cycle : ¬ IsSymbolicCycle (by decide : 0 < 7) (reconstructArcs z0.2 z0.1.val) z0.2 := by
  apply symbolic_cut_contradiction (by decide : 0 < 7)
...
theorem z4_not_cycle : ¬ IsSymbolicCycle (by decide : 0 < 7) (reconstructArcs z4.2 z4.1.val) z4.2 := by
  apply symbolic_cut_contradiction (by decide : 0 < 7)
    (reconstructArcs z4.2 z4.1.val) z4.2 C4 (0:Fin 7) (2:Fin 7)
  all_goals decide +kernel
def z5 : Fin 2 × Finset (Sym2 (Fin 7)) := ((1:Fin 2), {s(2,6),s(3,5)})
def C5 : Finset (Fin 7) := {0,1,2,6}
theorem z5_not_cycle : ¬ IsSymbolicCycle (by decide : 0 < 7) (reconstructArcs z5.2 z5.1.val) z5.2 := by
  apply symbolic_cut_contradiction (by decide : 0 < 7)
    (reconstructArcs z5.2 z5.1.val) z5.2 C5 (0:Fin 7) (3:Fin 7)
  all_goals decide +kernel
def z6 : Fin 2 × Finset (Sym2 (Fin 7)) := ((0:Fin 2), {s(0,1),s(2,6),s(3,5)})
def C6 : Finset (Fin 7) := {0,1,2,6}
theorem z6_not_cycle : ¬ IsSymbolicCycle (by decide : 0 < 7) (reconstructArcs z6.2 z6.1.val) z6.2 := by
  apply symbolic_cut_contradiction (by decide : 0 < 7)
    (reconstructArcs z6.2 z6.1.val) z6.2 C6 (0:Fin 7) (3:Fin 7)
  all_goals decide +kernel
def z7 : Fin 2 × Finset (Sym2 (Fin 7)) := ((1:Fin 2), {s(0,1),s(2,6),s(3,5)})
def C7 : Finset (Fin 7) := {0,1}
theorem z7_not_cycle : ¬ IsSymbolicCycle (by decide : 0 < 7) (reconstructArcs z7.2 z7.1.val) z7.2 := by
  apply symbolic_cut_contradiction (by decide : 0 < 7)
    (reconstructArcs z7.2 z7.1.val) z7.2 C7 (0:Fin 7) (2:Fin 7)
  all_goals decide +kernel
def z8 : Fin 2 × Finset (Sym2 (Fin 7)) := ((1:Fin 2), {s(0,1),s(2,4),s(2,6),s(3,5)})
def C8 : Finset (Fin 7) := {0,1}
theorem z8_not_cycle : ¬ IsSymbolicCycle (by decide : 0 < 7) (reconstructArcs z8.2 z8.1.val) z8.2 := by
  apply symbolic_cut_contradiction (by decide : 0 < 7)
    (reconstructArcs z8.2 z8.1.val) z8.2 C8 (0:Fin 7) (2:Fin 7)
  all_goals decide +kernel
def z9 : Fin 2 × Finset (Sym2 (Fin 7)) := ((1:Fin 2), {s(0,1),s(3,6)})
def C9 : Finset (Fin 7) := {0,1}
theorem z9_not_cycle : ¬ IsSymbolicCycle (by decide : 0 < 7) (reconstructArcs z9.2 z9.1.val) z9.2 := by
  apply symbolic_cut_contradiction (by decide : 0 < 7)
    (reconstructArcs z9.2 z9.1.val) z9.2 C9 (0:Fin 7) (3:Fin 7)
  all_goals decide +kernel
def z10 : Fin 2 × Finset (Sym2 (Fin 7)) := ((1:Fin 2), {s(0,1),s(2,4),s(3,6)})
def C10 : Finset (Fin 7) := {0,1}
theorem z10_not_cycle : ¬ IsSymbolicCycle (by decide : 0 < 7) (reconstructArcs z10.2 z10.1.val) z10.2 := by
  apply symbolic_cut_contradiction (by decide : 0 < 7)
    (reconstructArcs z10.2 z10.1.val) z10.2 C10 (0:Fin 7) (2:Fin 7)
  all_goals decide +kernel
def z11 : Fin 2 × Finset (Sym2 (Fin 7)) := ((1:Fin 2), {s(0,1),s(2,6),s(3,6)})
def C11 : Finset (Fin 7) := {0,1}
theorem z11_not_cycle : ¬ IsSymbolicCycle (by decide : 0 < 7) (reconstructArcs z11.2 z11.1.val) z11.2 := by
  apply symbolic_cut_contradiction (by decide : 0 < 7)
    (reconstructArcs z11.2 z11.1.val) z11.2 C11 (0:Fin 7) (2:Fin 7)
  all_goals decide +kernel
def z12 : Fin 2 × Finset (Sym2 (Fin 7)) := ((1:Fin 2), {s(0,1),s(2,4),s(2,6),s(3,6)})
def C12 : Finset (Fin 7) := {0,1}
theorem z12_not_cycle : ¬ IsSymbolicCycle (by decide : 0 < 7) (reconstructArcs z12.2 z12.1.val) z12.2 := by
  apply symbolic_cut_contradiction (by decide : 0 < 7)
    (reconstructArcs z12.2 z12.1.val) z12.2 C12 (0:Fin 7) (2:Fin 7)
  all_goals decide +kernel
def z13 : Fin 2 × Finset (Sym2 (Fin 7)) := ((1:Fin 2), {s(0,1),s(3,5),s(3,6)})
...
theorem z13_not_cycle : ¬ IsSymbolicCycle (by decide : 0 < 7) (reconstructArcs z13.2 z13.1.val) z13.2 := by
  ...
  all_goals decide +kernel
def z14 : Fin 2 × Finset (Sym2 (Fin 7)) := ((1:Fin 2), {s(0,1),s(2,4),s(2,6),s(3,5),s(3,6)})
...
theorem infeasible : ¬ ModelFeasible (by decide : 0 < 7) chords :=
  no_model_of_pruned_forms_card (by decide) (by decide) chords bad bad_not_cycle small
end JSP846Seven.R285
#print axioms JSP846Seven.R285.infeasible
namespace JSP846Seven.R286
open JSP846Standard
def chords : Finset (Sym2 (Fin 7)) := {s(0,1),s(2,4),s(2,6),s(3,5),s(4,6)}
def z0 : Fin 2 × Finset (Sym2 (Fin 7)) := ((1:Fin 2), {s(0,1),s(2,4)})
def C0 : Finset (Fin 7) := {0,1}
theorem z0_not_cycle : ¬ IsSymbolicCycle (by decide : 0 < 7) (reconstructArcs z0.2 z0.1.val) z0.2 := by
  apply symbolic_cut_contradiction (by decide : 0 < 7)
...
theorem z9_not_cycle : ¬ IsSymbolicCycle (by decide : 0 < 7) (reconstructArcs z9.2 z9.1.val) z9.2 := by
  ...
  all_goals decide +kernel
def z10 : Fin 2 × Finset (Sym2 (Fin 7)) := ((1:Fin 2), {s(0,1),s(2,6),s(4,6)})
def C10 : Finset (Fin 7) := {0,1}
theorem z10_not_cycle : ¬ IsSymbolicCycle (by decide : 0 < 7) (reconstructArcs z10.2 z10.1.val) z10.2 := by
  apply symbolic_cut_contradiction (by decide : 0 < 7)
    (reconstructArcs z10.2 z10.1.val) z10.2 C10 (0:Fin 7) (2:Fin 7)
  all_goals decide +kernel
def z11 : Fin 2 × Finset (Sym2 (Fin 7)) := ((1:Fin 2), {s(0,1),s(2,4),s(2,6),s(4,6)})
def C11 : Finset (Fin 7) := {0,1}
theorem z11_not_cycle : ¬ IsSymbolicCycle (by decide : 0 < 7) (reconstructArcs z11.2 z11.1.val) z11.2 := by
  apply symbolic_cut_contradiction (by decide : 0 < 7)
    (reconstructArcs z11.2 z11.1.val) z11.2 C11 (0:Fin 7) (2:Fin 7)
...
theorem z12_not_cycle : ¬ IsSymbolicCycle (by decide : 0 < 7) (reconstructArcs z12.2 z12.1.val) z12.2 := by
  ...
  all_goals decide +kernel
def z13 : Fin 2 × Finset (Sym2 (Fin 7)) := ((1:Fin 2), {s(0,1),s(2,4),s(3,5),s(4,6)})
def C13 : Finset (Fin 7) := {0,1}
theorem z13_not_cycle : ¬ IsSymbolicCycle (by decide : 0 < 7) (reconstructArcs z13.2 z13.1.val) z13.2 := by
  apply symbolic_cut_contradiction (by decide : 0 < 7)
    (reconstructArcs z13.2 z13.1.val) z13.2 C13 (0:Fin 7) (2:Fin 7)
  all_goals decide +kernel
def z14 : Fin 2 × Finset (Sym2 (Fin 7)) := ((1:Fin 2), {s(0,1),s(2,6),s(3,5),s(4,6)})
def C14 : Finset (Fin 7) := {0,1}
theorem z14_not_cycle : ¬ IsSymbolicCycle (by decide : 0 < 7) (reconstructArcs z14.2 z14.1.val) z14.2 := by
  apply symbolic_cut_contradiction (by decide : 0 < 7)
    (reconstructArcs z14.2 z14.1.val) z14.2 C14 (0:Fin 7) (2:Fin 7)
...
theorem infeasible : ¬ ModelFeasible (by decide : 0 < 7) chords :=
  no_model_of_pruned_forms_card (by decide) (by decide) chords bad bad_not_cycle small
end JSP846Seven.R286
#print axioms JSP846Seven.R286.infeasible
namespace JSP846Seven.R287
open JSP846Standard
def chords : Finset (Sym2 (Fin 7)) := {s(0,2),s(0,3),s(0,4),s(0,5),s(1,6)}
def bad : Finset (Fin 2 × Finset (Sym2 (Fin 7))) := ∅
theorem bad_not_cycle : ∀ z ∈ bad, ¬ IsSymbolicCycle (by decide : 0 < 7) (reconstructArcs z.2 z.1.val) z.2 := by
  intro z hz
  simpa [bad] using hz
theorem small : (prunedForms chords bad).card < 39 := by decide +kernel
theorem infeasible : ¬ ModelFeasible (by decide : 0 < 7) chords :=
  no_model_of_pruned_forms_card (by decide) (by decide) chords bad bad_not_cycle small
end JSP846Seven.R287
#print axioms JSP846Seven.R287.infeasible
namespace JSP846Seven.R288
open JSP846Standard
def chords : Finset (Sym2 (Fin 7)) := {s(0,2),s(0,3),s(0,4),s(1,5),s(1,6)}
def z0 : Fin 2 × Finset (Sym2 (Fin 7)) := ((0:Fin 2), {s(0,2),s(0,3),s(1,5),s(1,6)})
def C0 : Finset (Fin 7) := {0,2,3}
theorem z0_not_cycle : ¬ IsSymbolicCycle (by decide : 0 < 7) (reconstructArcs z0.2 z0.1.val) z0.2 := by
  apply symbolic_cut_contradiction (by decide : 0 < 7)
    (reconstructArcs z0.2 z0.1.val) z0.2 C0 (0:Fin 7) (1:Fin 7)
  all_goals decide +kernel
def z1 : Fin 2 × Finset (Sym2 (Fin 7)) := ((0:Fin 2), {s(0,2),s(0,4),s(1,5),s(1,6)})
def C1 : Finset (Fin 7) := {0,2,3,4}
theorem z1_not_cycle : ¬ IsSymbolicCycle (by decide : 0 < 7) (reconstructArcs z1.2 z1.1.val) z1.2 := by
  apply symbolic_cut_contradiction (by decide : 0 < 7)
    (reconstructArcs z1.2 z1.1.val) z1.2 C1 (0:Fin 7) (1:Fin 7)
  all_goals decide +kernel
def z2 : Fin 2 × Finset (Sym2 (Fin 7)) := ((0:Fin 2), {s(0,3),s(0,4),s(1,5),s(1,6)})
...
theorem infeasible : ¬ ModelFeasible (by decide : 0 < 7) chords :=
  no_model_of_pruned_forms_card (by decide) (by decide) chords bad bad_not_cycle small
end JSP846Seven.R288
#print axioms JSP846Seven.R288.infeasible
