...
namespace JSP846Nine.R103P
open JSP846Standard
def chords : Finset (Sym2 (Fin 9)) := {s(0,1),s(2,3),s(4,6),s(5,7),s(5,8)}
...
theorem z15_not_cycle : ¬ IsSymbolicCycle (by decide : 0 < 9) (reconstructArcs z15.2 z15.1.val) z15.2 := by
  ...
  all_goals decide +kernel
def z16 : Fin 2 × Finset (Sym2 (Fin 9)) := ((1:Fin 2), {s(0,1),s(5,7),s(5,8)})
...
theorem z16_not_cycle : ¬ IsSymbolicCycle (by decide : 0 < 9) (reconstructArcs z16.2 z16.1.val) z16.2 := by
  ...
  all_goals decide +kernel
def z17 : Fin 2 × Finset (Sym2 (Fin 9)) := ((0:Fin 2), {s(2,3),s(5,7),s(5,8)})
def C17 : Finset (Fin 9) := {2,3}
theorem z17_not_cycle : ¬ IsSymbolicCycle (by decide : 0 < 9) (reconstructArcs z17.2 z17.1.val) z17.2 := by
  apply symbolic_cut_contradiction (by decide : 0 < 9) (reconstructArcs z17.2 z17.1.val) z17.2 C17 (2:Fin 9) (5:Fin 9)
  all_goals decide +kernel
def z18 : Fin 2 × Finset (Sym2 (Fin 9)) := ((1:Fin 2), {s(0,1),s(2,3),s(5,7),s(5,8)})
...
end JSP846Nine.R103P
#print axioms JSP846Nine.R103P.infeasible
