...
namespace JSP846Seven.R250
open JSP846Standard
def chords : Finset (Sym2 (Fin 7)) := {s(0,1),s(0,4),s(2,5),s(3,6),s(4,6)}
...
end JSP846Seven.R250
#print axioms JSP846Seven.R250.infeasible
namespace JSP846Seven.R251
open JSP846Standard
def chords : Finset (Sym2 (Fin 7)) := {s(0,1),s(0,4),s(2,6),s(3,5),s(3,6)}
...
theorem infeasible : ¬ ModelFeasible (by decide : 0 < 7) chords :=
  no_model_of_pruned_forms_card (by decide) (by decide) chords bad bad_not_cycle small
end JSP846Seven.R251
#print axioms JSP846Seven.R251.infeasible
namespace JSP846Seven.R252
open JSP846Standard
def chords : Finset (Sym2 (Fin 7)) := {s(0,1),s(0,4),s(2,6),s(3,5),s(4,6)}
def z0 : Fin 2 × Finset (Sym2 (Fin 7)) := ((1:Fin 2), {s(0,1),s(2,6)})
def C0 : Finset (Fin 7) := {0,1}
theorem z0_not_cycle : ¬ IsSymbolicCycle (by decide : 0 < 7) (reconstructArcs z0.2 z0.1.val) z0.2 := by
  apply symbolic_cut_contradiction (by decide : 0 < 7)
...
theorem infeasible : ¬ ModelFeasible (by decide : 0 < 7) chords :=
  no_model_of_pruned_forms_card (by decide) (by decide) chords bad bad_not_cycle small
end JSP846Seven.R252
#print axioms JSP846Seven.R252.infeasible
namespace JSP846Seven.R253
open JSP846Standard
def chords : Finset (Sym2 (Fin 7)) := {s(0,1),s(0,5),s(1,2),s(2,3),s(4,6)}
...
theorem infeasible : ¬ ModelFeasible (by decide : 0 < 7) chords :=
  no_model_of_pruned_forms_card (by decide) (by decide) chords bad bad_not_cycle small
end JSP846Seven.R253
#print axioms JSP846Seven.R253.infeasible
namespace JSP846Seven.R255
open JSP846Standard
def chords : Finset (Sym2 (Fin 7)) := {s(0,1),s(0,5),s(1,2),s(3,4),s(4,6)}
def z0 : Fin 2 × Finset (Sym2 (Fin 7)) := ((0:Fin 2), {s(0,5),s(1,2)})
def C0 : Finset (Fin 7) := {0,5,6}
theorem z0_not_cycle : ¬ IsSymbolicCycle (by decide : 0 < 7) (reconstructArcs z0.2 z0.1.val) z0.2 := by
  apply symbolic_cut_contradiction (by decide : 0 < 7)
...
theorem z3_not_cycle : ¬ IsSymbolicCycle (by decide : 0 < 7) (reconstructArcs z3.2 z3.1.val) z3.2 := by
  ...
  all_goals decide +kernel
def z4 : Fin 2 × Finset (Sym2 (Fin 7)) := ((0:Fin 2), {s(0,5),s(1,2),s(3,4)})
...
theorem z6_not_cycle : ¬ IsSymbolicCycle (by decide : 0 < 7) (reconstructArcs z6.2 z6.1.val) z6.2 := by
  ...
  all_goals decide +kernel
def z7 : Fin 2 × Finset (Sym2 (Fin 7)) := ((0:Fin 2), {s(0,5),s(1,2),s(4,6)})
...
theorem infeasible : ¬ ModelFeasible (by decide : 0 < 7) chords :=
  no_model_of_pruned_forms_card (by decide) (by decide) chords bad bad_not_cycle small
end JSP846Seven.R255
#print axioms JSP846Seven.R255.infeasible
