...
namespace JSP846Nine.R100P
open JSP846Standard
def chords : Finset (Sym2 (Fin 9)) := {s(0,1),s(0,8),s(2,7),s(3,6),s(4,5)}
...
def z1 : Fin 2 × Finset (Sym2 (Fin 9)) := ((0:Fin 2), {s(0,8),s(2,7)})
def C1 : Finset (Fin 9) := {0,8}
theorem z1_not_cycle : ¬ IsSymbolicCycle (by decide : 0 < 9) (reconstructArcs z1.2 z1.1.val) z1.2 := by
  ...
  all_goals decide +kernel
def z2 : Fin 2 × Finset (Sym2 (Fin 9)) := ((1:Fin 2), {s(0,1),s(3,6)})
...
theorem z2_not_cycle : ¬ IsSymbolicCycle (by decide : 0 < 9) (reconstructArcs z2.2 z2.1.val) z2.2 := by
  ...
  all_goals decide +kernel
def z3 : Fin 2 × Finset (Sym2 (Fin 9)) := ((0:Fin 2), {s(0,8),s(3,6)})
def C3 : Finset (Fin 9) := {0,8}
...
theorem z6_not_cycle : ¬ IsSymbolicCycle (by decide : 0 < 9) (reconstructArcs z6.2 z6.1.val) z6.2 := by
  ...
  all_goals decide +kernel
def z7 : Fin 2 × Finset (Sym2 (Fin 9)) := ((0:Fin 2), {s(0,8),s(2,7),s(3,6)})
def C7 : Finset (Fin 9) := {0,8}
theorem z7_not_cycle : ¬ IsSymbolicCycle (by decide : 0 < 9) (reconstructArcs z7.2 z7.1.val) z7.2 := by
  ...
  all_goals decide +kernel
def z8 : Fin 2 × Finset (Sym2 (Fin 9)) := ((1:Fin 2), {s(0,8),s(2,7),s(3,6)})
def C8 : Finset (Fin 9) := {0,1,2,7,8}
theorem z8_not_cycle : ¬ IsSymbolicCycle (by decide : 0 < 9) (reconstructArcs z8.2 z8.1.val) z8.2 := by
  ...
  all_goals decide +kernel
def z9 : Fin 2 × Finset (Sym2 (Fin 9)) := ((0:Fin 2), {s(0,1),s(0,8),s(2,7),s(3,6)})
def C9 : Finset (Fin 9) := {0,1,2,7,8}
theorem z9_not_cycle : ¬ IsSymbolicCycle (by decide : 0 < 9) (reconstructArcs z9.2 z9.1.val) z9.2 := by
  ...
  all_goals decide +kernel
def z10 : Fin 2 × Finset (Sym2 (Fin 9)) := ((1:Fin 2), {s(0,1),s(4,5)})
...
theorem z10_not_cycle : ¬ IsSymbolicCycle (by decide : 0 < 9) (reconstructArcs z10.2 z10.1.val) z10.2 := by
  ...
  all_goals decide +kernel
def z11 : Fin 2 × Finset (Sym2 (Fin 9)) := ((0:Fin 2), {s(0,8),s(4,5)})
def C11 : Finset (Fin 9) := {0,8}
theorem z11_not_cycle : ¬ IsSymbolicCycle (by decide : 0 < 9) (reconstructArcs z11.2 z11.1.val) z11.2 := by
  ...
  all_goals decide +kernel
def z12 : Fin 2 × Finset (Sym2 (Fin 9)) := ((1:Fin 2), {s(2,7),s(4,5)})
def C12 : Finset (Fin 9) := {0,1,2,7,8}
theorem z12_not_cycle : ¬ IsSymbolicCycle (by decide : 0 < 9) (reconstructArcs z12.2 z12.1.val) z12.2 := by
  ...
  all_goals decide +kernel
def z13 : Fin 2 × Finset (Sym2 (Fin 9)) := ((0:Fin 2), {s(0,1),s(2,7),s(4,5)})
...
theorem z13_not_cycle : ¬ IsSymbolicCycle (by decide : 0 < 9) (reconstructArcs z13.2 z13.1.val) z13.2 := by
  ...
  all_goals decide +kernel
def z14 : Fin 2 × Finset (Sym2 (Fin 9)) := ((1:Fin 2), {s(0,1),s(2,7),s(4,5)})
...
theorem z14_not_cycle : ¬ IsSymbolicCycle (by decide : 0 < 9) (reconstructArcs z14.2 z14.1.val) z14.2 := by
  ...
  all_goals decide +kernel
def z15 : Fin 2 × Finset (Sym2 (Fin 9)) := ((0:Fin 2), {s(0,8),s(2,7),s(4,5)})
def C15 : Finset (Fin 9) := {0,8}
theorem z15_not_cycle : ¬ IsSymbolicCycle (by decide : 0 < 9) (reconstructArcs z15.2 z15.1.val) z15.2 := by
  ...
  all_goals decide +kernel
def z16 : Fin 2 × Finset (Sym2 (Fin 9)) := ((1:Fin 2), {s(0,8),s(2,7),s(4,5)})
def C16 : Finset (Fin 9) := {0,1,2,7,8}
theorem z16_not_cycle : ¬ IsSymbolicCycle (by decide : 0 < 9) (reconstructArcs z16.2 z16.1.val) z16.2 := by
  ...
  all_goals decide +kernel
def z17 : Fin 2 × Finset (Sym2 (Fin 9)) := ((0:Fin 2), {s(0,1),s(0,8),s(2,7),s(4,5)})
def C17 : Finset (Fin 9) := {0,1,2,7,8}
theorem z17_not_cycle : ¬ IsSymbolicCycle (by decide : 0 < 9) (reconstructArcs z17.2 z17.1.val) z17.2 := by
  ...
  all_goals decide +kernel
def z18 : Fin 2 × Finset (Sym2 (Fin 9)) := ((1:Fin 2), {s(3,6),s(4,5)})
def C18 : Finset (Fin 9) := {0,1,2,3,6,7,8}
theorem z18_not_cycle : ¬ IsSymbolicCycle (by decide : 0 < 9) (reconstructArcs z18.2 z18.1.val) z18.2 := by
  apply symbolic_cut_contradiction (by decide : 0 < 9) (reconstructArcs z18.2 z18.1.val) z18.2 C18 (0:Fin 9) (4:Fin 9)
  all_goals decide +kernel
def z19 : Fin 2 × Finset (Sym2 (Fin 9)) := ((0:Fin 2), {s(0,1),s(3,6),s(4,5)})
def C19 : Finset (Fin 9) := {0,1,2,3,6,7,8}
theorem z19_not_cycle : ¬ IsSymbolicCycle (by decide : 0 < 9) (reconstructArcs z19.2 z19.1.val) z19.2 := by
  ...
  all_goals decide +kernel
def z20 : Fin 2 × Finset (Sym2 (Fin 9)) := ((1:Fin 2), {s(0,1),s(3,6),s(4,5)})
...
theorem z20_not_cycle : ¬ IsSymbolicCycle (by decide : 0 < 9) (reconstructArcs z20.2 z20.1.val) z20.2 := by
  ...
  all_goals decide +kernel
def z21 : Fin 2 × Finset (Sym2 (Fin 9)) := ((0:Fin 2), {s(0,8),s(3,6),s(4,5)})
def C21 : Finset (Fin 9) := {0,8}
theorem z21_not_cycle : ¬ IsSymbolicCycle (by decide : 0 < 9) (reconstructArcs z21.2 z21.1.val) z21.2 := by
  apply symbolic_cut_contradiction (by decide : 0 < 9) (reconstructArcs z21.2 z21.1.val) z21.2 C21 (0:Fin 9) (3:Fin 9)
  all_goals decide +kernel
def z22 : Fin 2 × Finset (Sym2 (Fin 9)) := ((1:Fin 2), {s(0,8),s(3,6),s(4,5)})
...
theorem z22_not_cycle : ¬ IsSymbolicCycle (by decide : 0 < 9) (reconstructArcs z22.2 z22.1.val) z22.2 := by
  ...
  all_goals decide +kernel
def z23 : Fin 2 × Finset (Sym2 (Fin 9)) := ((0:Fin 2), {s(0,1),s(0,8),s(3,6),s(4,5)})
...
theorem z27_not_cycle : ¬ IsSymbolicCycle (by decide : 0 < 9) (reconstructArcs z27.2 z27.1.val) z27.2 := by
  ...
  all_goals decide +kernel
def z28 : Fin 2 × Finset (Sym2 (Fin 9)) := ((0:Fin 2), {s(0,8),s(2,7),s(3,6),s(4,5)})
def C28 : Finset (Fin 9) := {0,8}
theorem z28_not_cycle : ¬ IsSymbolicCycle (by decide : 0 < 9) (reconstructArcs z28.2 z28.1.val) z28.2 := by
  ...
  all_goals decide +kernel
def z29 : Fin 2 × Finset (Sym2 (Fin 9)) := ((1:Fin 2), {s(0,8),s(2,7),s(3,6),s(4,5)})
def C29 : Finset (Fin 9) := {0,1,2,7,8}
theorem z29_not_cycle : ¬ IsSymbolicCycle (by decide : 0 < 9) (reconstructArcs z29.2 z29.1.val) z29.2 := by
  ...
  all_goals decide +kernel
def z30 : Fin 2 × Finset (Sym2 (Fin 9)) := ((0:Fin 2), {s(0,1),s(0,8),s(2,7),s(3,6),s(4,5)})
def C30 : Finset (Fin 9) := {0,1,2,7,8}
...
end JSP846Nine.R100P
#print axioms JSP846Nine.R100P.infeasible
