...
namespace JSP846EightLarge.C177P
open JSP846Standard
open JSP846Replay
def chords : Finset (Sym2 (Fin 8)) := {s(0,3),s(0,5),s(1,4),s(2,7),s(3,6)}
...
theorem z1_not_cycle : ¬ IsSymbolicCycle (by decide : 0 < 8) (reconstructArcs z1.2 z1.1.val) z1.2 := by
  ...
  all_goals decide +kernel
def z2 : Fin 2 × Finset (Sym2 (Fin 8)) := ((1:Fin 2), {s(0,5),s(1,4),s(2,7),s(3,6)})
...
def replayForms : List JSP846Replay.Form :=
  JSP846Residual.HintCases.C177.forms.map JSP846HintBridge.exprToForm
...
theorem excluded : ¬ ModelFeasible (by decide : 0 < 8) chords := by
  ...
  have hb : JSP846Residual.Bounds JSP846Residual.HintCases.C177.lower xs := by
    simp [JSP846Residual.HintCases.C177.lower, xs, JSP846HintBridge.finList8,
  ...
  have hc' : JSP846Replay.Covers
      (JSP846Replay.values (JSP846HintBridge.listWeight xs)
        (JSP846Residual.HintCases.C177.forms.map JSP846HintBridge.exprToForm)) := by
    have hwEq := JSP846HintBridge.listWeight_finList8 w
    rw [hwEq]
    simpa [replayForms] using hc
  have ho : JSP846Residual.OriginalFeasible
      JSP846Residual.HintCases.C177.lower
      JSP846Residual.HintCases.C177.forms :=
    JSP846HintBridge.originalFeasible_of_replay
      JSP846Residual.HintCases.C177.lower
      JSP846Residual.HintCases.C177.forms xs hb hs hc'
  exact JSP846Residual.HintCases.C177.infeasible ho

end JSP846EightLarge.C177P
#print axioms JSP846EightLarge.C177P.table_exact
#print axioms JSP846EightLarge.C177P.excluded
