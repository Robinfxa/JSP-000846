...
namespace JSP846Nine.R128P
open JSP846Standard
def chords : Finset (Sym2 (Fin 9)) := {s(0,1),s(2,4),s(3,8),s(5,8),s(6,7)}
...
def z1 : Fin 2 × Finset (Sym2 (Fin 9)) := ((1:Fin 2), {s(0,1),s(3,8)})
...
theorem z1_not_cycle : ¬ IsSymbolicCycle (by decide : 0 < 9) (reconstructArcs z1.2 z1.1.val) z1.2 := by
  ...
  all_goals decide +kernel
def z2 : Fin 2 × Finset (Sym2 (Fin 9)) := ((1:Fin 2), {s(0,1),s(2,4),s(3,8)})
...
theorem z5_not_cycle : ¬ IsSymbolicCycle (by decide : 0 < 9) (reconstructArcs z5.2 z5.1.val) z5.2 := by
  ...
  all_goals decide +kernel
def z6 : Fin 2 × Finset (Sym2 (Fin 9)) := ((1:Fin 2), {s(0,1),s(3,8),s(5,8)})
...
theorem z6_not_cycle : ¬ IsSymbolicCycle (by decide : 0 < 9) (reconstructArcs z6.2 z6.1.val) z6.2 := by
  ...
  all_goals decide +kernel
def z7 : Fin 2 × Finset (Sym2 (Fin 9)) := ((1:Fin 2), {s(0,1),s(2,4),s(3,8),s(5,8)})
...
theorem z8_not_cycle : ¬ IsSymbolicCycle (by decide : 0 < 9) (reconstructArcs z8.2 z8.1.val) z8.2 := by
  ...
  all_goals decide +kernel
def z9 : Fin 2 × Finset (Sym2 (Fin 9)) := ((0:Fin 2), {s(2,4),s(6,7)})
def C9 : Finset (Fin 9) := {2,3,4}
theorem z9_not_cycle : ¬ IsSymbolicCycle (by decide : 0 < 9) (reconstructArcs z9.2 z9.1.val) z9.2 := by
  apply symbolic_cut_contradiction (by decide : 0 < 9) (reconstructArcs z9.2 z9.1.val) z9.2 C9 (2:Fin 9) (6:Fin 9)
  all_goals decide +kernel
def z10 : Fin 2 × Finset (Sym2 (Fin 9)) := ((1:Fin 2), {s(0,1),s(2,4),s(6,7)})
...
theorem z10_not_cycle : ¬ IsSymbolicCycle (by decide : 0 < 9) (reconstructArcs z10.2 z10.1.val) z10.2 := by
  ...
  all_goals decide +kernel
def z11 : Fin 2 × Finset (Sym2 (Fin 9)) := ((1:Fin 2), {s(3,8),s(6,7)})
def C11 : Finset (Fin 9) := {0,1,2,3,8}
theorem z11_not_cycle : ¬ IsSymbolicCycle (by decide : 0 < 9) (reconstructArcs z11.2 z11.1.val) z11.2 := by
  ...
  all_goals decide +kernel
def z12 : Fin 2 × Finset (Sym2 (Fin 9)) := ((0:Fin 2), {s(0,1),s(3,8),s(6,7)})
def C12 : Finset (Fin 9) := {0,1,2,3,8}
theorem z12_not_cycle : ¬ IsSymbolicCycle (by decide : 0 < 9) (reconstructArcs z12.2 z12.1.val) z12.2 := by
  ...
  all_goals decide +kernel
def z13 : Fin 2 × Finset (Sym2 (Fin 9)) := ((1:Fin 2), {s(0,1),s(3,8),s(6,7)})
...
theorem z13_not_cycle : ¬ IsSymbolicCycle (by decide : 0 < 9) (reconstructArcs z13.2 z13.1.val) z13.2 := by
  ...
  all_goals decide +kernel
def z14 : Fin 2 × Finset (Sym2 (Fin 9)) := ((1:Fin 2), {s(2,4),s(3,8),s(6,7)})
def C14 : Finset (Fin 9) := {0,1,2,3,4,8}
theorem z14_not_cycle : ¬ IsSymbolicCycle (by decide : 0 < 9) (reconstructArcs z14.2 z14.1.val) z14.2 := by
  ...
  all_goals decide +kernel
def z15 : Fin 2 × Finset (Sym2 (Fin 9)) := ((0:Fin 2), {s(0,1),s(2,4),s(3,8),s(6,7)})
def C15 : Finset (Fin 9) := {0,1,2,3,4,8}
theorem z15_not_cycle : ¬ IsSymbolicCycle (by decide : 0 < 9) (reconstructArcs z15.2 z15.1.val) z15.2 := by
  ...
  all_goals decide +kernel
def z16 : Fin 2 × Finset (Sym2 (Fin 9)) := ((1:Fin 2), {s(0,1),s(2,4),s(3,8),s(6,7)})
def C16 : Finset (Fin 9) := {0,1}
theorem z16_not_cycle : ¬ IsSymbolicCycle (by decide : 0 < 9) (reconstructArcs z16.2 z16.1.val) z16.2 := by
  apply symbolic_cut_contradiction (by decide : 0 < 9) (reconstructArcs z16.2 z16.1.val) z16.2 C16 (0:Fin 9) (2:Fin 9)
  all_goals decide +kernel
...
theorem z19_not_cycle : ¬ IsSymbolicCycle (by decide : 0 < 9) (reconstructArcs z19.2 z19.1.val) z19.2 := by
  ...
  all_goals decide +kernel
def z20 : Fin 2 × Finset (Sym2 (Fin 9)) := ((0:Fin 2), {s(2,4),s(5,8),s(6,7)})
def C20 : Finset (Fin 9) := {2,3,4}
theorem z20_not_cycle : ¬ IsSymbolicCycle (by decide : 0 < 9) (reconstructArcs z20.2 z20.1.val) z20.2 := by
  apply symbolic_cut_contradiction (by decide : 0 < 9) (reconstructArcs z20.2 z20.1.val) z20.2 C20 (2:Fin 9) (5:Fin 9)
  all_goals decide +kernel
def z21 : Fin 2 × Finset (Sym2 (Fin 9)) := ((1:Fin 2), {s(2,4),s(5,8),s(6,7)})
def C21 : Finset (Fin 9) := {0,1,2,4,5,8}
theorem z21_not_cycle : ¬ IsSymbolicCycle (by decide : 0 < 9) (reconstructArcs z21.2 z21.1.val) z21.2 := by
  ...
  all_goals decide +kernel
def z22 : Fin 2 × Finset (Sym2 (Fin 9)) := ((0:Fin 2), {s(0,1),s(2,4),s(5,8),s(6,7)})
...
theorem z22_not_cycle : ¬ IsSymbolicCycle (by decide : 0 < 9) (reconstructArcs z22.2 z22.1.val) z22.2 := by
  ...
  all_goals decide +kernel
def z23 : Fin 2 × Finset (Sym2 (Fin 9)) := ((1:Fin 2), {s(0,1),s(2,4),s(5,8),s(6,7)})
...
theorem z23_not_cycle : ¬ IsSymbolicCycle (by decide : 0 < 9) (reconstructArcs z23.2 z23.1.val) z23.2 := by
  ...
  all_goals decide +kernel
def z24 : Fin 2 × Finset (Sym2 (Fin 9)) := ((0:Fin 2), {s(3,8),s(5,8),s(6,7)})
def C24 : Finset (Fin 9) := {3,4,5,8}
theorem z24_not_cycle : ¬ IsSymbolicCycle (by decide : 0 < 9) (reconstructArcs z24.2 z24.1.val) z24.2 := by
  apply symbolic_cut_contradiction (by decide : 0 < 9) (reconstructArcs z24.2 z24.1.val) z24.2 C24 (3:Fin 9) (6:Fin 9)
  all_goals decide +kernel
def z25 : Fin 2 × Finset (Sym2 (Fin 9)) := ((1:Fin 2), {s(0,1),s(3,8),s(5,8),s(6,7)})
...
theorem z25_not_cycle : ¬ IsSymbolicCycle (by decide : 0 < 9) (reconstructArcs z25.2 z25.1.val) z25.2 := by
  ...
  all_goals decide +kernel
def z26 : Fin 2 × Finset (Sym2 (Fin 9)) := ((0:Fin 2), {s(2,4),s(3,8),s(5,8),s(6,7)})
def C26 : Finset (Fin 9) := {2,3,4,5,8}
theorem z26_not_cycle : ¬ IsSymbolicCycle (by decide : 0 < 9) (reconstructArcs z26.2 z26.1.val) z26.2 := by
  apply symbolic_cut_contradiction (by decide : 0 < 9) (reconstructArcs z26.2 z26.1.val) z26.2 C26 (2:Fin 9) (6:Fin 9)
  all_goals decide +kernel
def z27 : Fin 2 × Finset (Sym2 (Fin 9)) := ((1:Fin 2), {s(0,1),s(2,4),s(3,8),s(5,8),s(6,7)})
...
end JSP846Nine.R128P
#print axioms JSP846Nine.R128P.infeasible
